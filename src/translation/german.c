...
static translation_string all_strings[] = {
    ...
    {TR_EDITOR_REPEAT_INTERVAL_TYPE, "ZEIT"},
    {TR_PLACEHOLDER, "Platzhalter" },
    {TR_WARNING_CANT_REPAIR_MONUMENTS, "Besondere Monumente können nicht repariert werden" },
    {TR_WARNING_CANT_REPAIR_AQUEDUCTS, "Aquädukte können nicht repariert werden"},
    {TR_OVERLAY_HOUSING_TENTS, "Zelte"},
    {TR_OVERLAY_HOUSING_SHACKS, "Hütten"},
    {TR_OVERLAY_HOUSING_HOVELS, "Häuser"},
    {TR_OVERLAY_HOUSING_CASAS, "Casen"},
    {TR_OVERLAY_HOUSE_INSULAS, "Insulae"},
    {TR_OVERLAY_HOUSE_VILLAS, "Villen"},
    {TR_OVERLAY_HOUSE_PALACES, "Paläste"},
    {TR_OVERLAY_BY_GROUP, "Nach Gruppe"},
    {TR_EDITOR_PARAMETER_CITY_PROPERTY, "Stadteigenschaft" },
    {TR_EDITOR_ACTION_TYPE_CITY_PROPERTY, "Wert der benutzerdefinierten Variablen änderen (Stadteigenschaft)" },
    {TR_PARAMETER_PERCENTAGE, "Prozentsatz" },
    {TR_PARAMETER_ABSOLUTE, "Absolut" },
    {TR_DECENNIUM_0, "0-9"},
    ...
    {TR_CITY_PROPERTY_NONE, "Keine"},
    {TR_CITY_PROPERTY_DIFFICULTY, "Schwierigkeit"},
    {TR_CITY_PROPERTY_MONEY, "Geld"},
    {TR_CITY_PROPERTY_POPULATION, "Bevölkerung"},
    {TR_CITY_PROPERTY_SAVINGS, "Persönliche Ersparnisse"},
    {TR_CITY_PROPERTY_YEAR_FINANCE_BALANCE, "Jährliche Finanz Bilanz"},
    {TR_CITY_PROPERTY_RESOURCE_STOCK, "Resourcen"},
    {TR_CITY_PROPERTY_STATS_FAVOR, "Gunst"},
    {TR_CITY_PROPERTY_STATS_PROSPERITY, "Wohlstand"},
    {TR_CITY_PROPERTY_STATS_CULTURE, "Kultur"},
    {TR_CITY_PROPERTY_STATS_PEACE, "Frieden"},
    {TR_CITY_PROPERTY_STATS_CITY_HEALTH, "Gesamtgesundheit"},
    {TR_CITY_PROPERTY_SERVICE_COVERAGE, "Serviceabdeckung"},
    {TR_CITY_PROPERTY_POPS_UNEMPLOYMENT, "Arbeitslosenquote"},
    {TR_CITY_PROPERTY_POPS_HOUSING_TYPE, "Bevölkerung pro Haustyp"},
    {TR_CITY_PROPERTY_POPS_BY_AGE, "Bevölkerung pro Alter"},
    {TR_CITY_PROPERTY_ROME_WAGES, "Löhne Rom"},
    {TR_CITY_PROPERTY_CITY_WAGES, "Löhne Stadt"},
    {TR_CITY_PROPERTY_BUILDING_COUNT, "Anzahl an Gebäude"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_PLAYER, "Truppen des Spielers"},
    {TR_CITY_PROPERTY_TROOPS_COUNT_ENEMY, "Truppen des Gegners"},
    {TR_CITY_PROPERTY_TERRAIN_COUNT_TILES, "Felder des Terrains"},
    {TR_CITY_PROPERTY_TROOPS_MELEE, "Nahkampftruppen"},
    {TR_CITY_PROPERTY_TROOPS_RANGED, "Fernkampftruppen"},
    {TR_CITY_PROPERTY_TROOPS_MOUNTED, "Reitende Truppen"},
    {TR_CITY_PROPERTY_ALL, "Alle"},
    {TR_CITY_PROPERTY_ACTIVE_ONLY, "Nur Aktive"},
    {TR_CITY_PROPERTY_COVERAGE_THEATRE, "Theater Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_ARENA, "Arena Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_AMPHITHEATRE, "Amphitheater Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_TAVERN, "Tavernen Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_COLOSSEUM, "Kolosseum Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_HIPPODROME, "Hippodrom Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_BATHS, "Badehaus Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_DOCTOR, "Doktor Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_BARBER, "Barbier Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_HOSPITAL, "Krankenhaus Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_SCHOOL, "Schulabdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_LIBRARY, "Bibilotheks Abdeckung"},
    {TR_CITY_PROPERTY_COVERAGE_ACADEMY, "Akademie Abdeckung"},
    {TR_CITY_PROPERTY_CHOOSE_PROPERTY, "Wähle eine Stadteigenschaft"},
    {TR_BUTTON_INFO_RETURN_ALL_LEGIONS, "Schicke alle Legionen zurück zum Fort"},
    {TR_CITY_PROPERTY_QUOTA_FILL, "Handelsrate"},
    {TR_EDITOR_BUYS, "(Kauft)"},
    {TR_EDITOR_SELLS, "(Verkauft)"},
    {TR_EDITOR_ALL_BUYS, "All (Kauft)"},
    {TR_EDITOR_ALL_SELLS, "All (Verkauft)"},
    {TR_ACTION_TYPE_WIN, "Sofortiger Gewinn"},
    {TR_ACTION_TYPE_LOSE, "Sofortiges Verlieren"},
    {TR_ACTION_TYPE_GOD_SENTIMENT, "Ändere Zufriedenheit des Gottes"},
    {TR_ACTION_TYPE_POP_SENTIMENT, "Ändere Zufriedenheit der Leute"},
    {TR_MESSAGE_PROMOTE_RANK_PREFIX, "Großartige Neuigkeiten, Gouvaneur! Von Ihrer Leistung beeindruckt, hat Caesar Euch befördert zum  "},
    {TR_MESSAGE_DEMOTE_RANK_PREFIX, "Kleinartige Neuigkeiten, Gouvaneur! Mit ihrer Leistung gänzlich unzufrieden, hat Caesar Euch dekradiert zum "},
    {TR_MESSAGE_PROMOTE_RANK_SUFFIX, ". Gut gemacht, das wird Ihrem Gehalt sicher nicht schaden!"},
    {TR_MESSAGE_DEMOTE_RANK_SUFFIX, ". Ihr Gehalt wird gekürtzt!"},
    {TR_PARAMETER_TYPE_RANK, "Rang"},
    {TR_RANK_PROMOTE, "Befördern (Rang +1)"},
    {TR_RANK_DEMOTE, "Dekradieren (Rang -1)"},
    {TR_RANK_CITIZEN, "Bürger"},
    {TR_RANK_CLERK, "Sekretär"},
    {TR_RANK_ENGINEER, "Ingeneur"},
    {TR_RANK_ARCHITECT, "Architekt"},
    {TR_RANK_QUAESTOR, "Quaestor"},
    {TR_RANK_PROCURATOR, "Prokurator"},
    {TR_RANK_AEDILE, "Aedile"},
    {TR_RANK_PRAETOR, "Praetor"},
    {TR_RANK_CONSUL, "Konsul"},
    {TR_RANK_PROCONSUL, "Prokonsul"},
    {TR_RANK_CAESAR, "Caesar"},
    {TR_ACTION_TYPE_CHANGE_RANK, "Ändere den Rang des Gouvaneurs"},
    {TR_CITY_MESSAGE_TITLE_GOVERNOR_RANK_CHANGE, "Rang des Gouvaneurs"},
    {TR_TOOLTIP_OVERLAY_LEVY_PER_TILE, " Denarii die monatlich pro Feld bezahlt werden"},
    {TR_CONFIG_UI_CV_BUILD_MENU_ICONS, "Zeige Resourcen im Baumenü"},
    {TR_EDITOR_RESET_FAVOR_MONTHLY, "Setze Gunst monatlich zurück"},
    ...
    {TR_EDITOR_COLOR_GREEN, "Grün" },
    {TR_EDITOR_COLOR_PURPLE, "Violett" },
    {TR_EDITOR_COLOR_OLIVE, "Olivgrün" },
    {TR_EDITOR_COLOR_TURQUOISE, "Türkis" },
    {TR_EDITOR_COLOR_CORAL, "Rot" },
    {TR_EDITOR_COLOR_GRAY, "Grau" },
    {TR_EDITOR_COLOR_BLACK, "Schwarz"},
    {TR_EDITOR_COLOR_DARK_BLUE, "Dunkelblau"},
    {TR_EDITOR_RUBBLE, "Ruine"},
    {TR_PARAMETER_GRID_OFFSET_CORNER1, "Ecke 1"},
    {TR_PARAMETER_GRID_OFFSET_CORNER2, "Ecke 2"},
    {TR_CONDITION_TYPE_TERRAIN_IN_AREA, "Terrain im Bereich"},
    {TR_CONFIG_UI_CV_CURSOR_SHADOW, "Cursor Schatten"},
    {TR_EDITOR_MODEL_PRODUCTION, "Rate"},
    {TR_ACTION_TYPE_PRODUCTION_RATE, "Ändere Produktionsrate"},
    {TR_EDITOR_EARTHQUAKE_RIGHT_TO_LEFT, "Von rechts nach links"},
    {TR_EDITOR_EARTHQUAKE_RANDOM, "Zufällig"},
    {TR_EDITOR_EARTHQUAKE_RANDOM_RIGHT_TO_LEFT, "Zufällig von rechts nach links"},
    {TR_EDITOR_DESIRABILITY_VALUE, "Attraktivitäts Wert\nDer Startwert des Gebäudes"},
    {TR_EDITOR_DESIRABILITY_STEP, "Attraktivitäts Schritt\nDie Distanz bis zur nächten Erhöhung/Verkleinerung des Wertes"},
    {TR_EDITOR_DESIRABILITY_STEP_SIZE, "Desirability step size\nDer Betrag der addiert/subtrahiert wird"},
    {TR_EDITOR_DESIRABILITY_RANGE, "Desirability range\nDie maximale Reichweite, außerhalb von ihr gibt es keinen Effekt"},
    {TR_EDITOR_EARTHQUAKE_PATTERN, "Muster"},
    {TR_CONFIG_GENERAL_UNLOCK_MOUSE, "Schließe Maus im Vollbildmodus ein" },
    {TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS, "Häuser verbinden sich immer im 2x2 Muster"},
    {TR_EDITOR_EARTHQUAKE_CUSTOM_SET, "Benutzerdefiniertes Erdbeben"},
    {TR_BUILDING_HOUSE_SMALL_TENT,    "Kleines Zelt"},
    {TR_BUILDING_HOUSE_LARGE_TENT,    "Großes Zelt"},
    {TR_BUILDING_HOUSE_SMALL_SHACK,   "Kleine Hütte"},
    {TR_BUILDING_HOUSE_LARGE_SHACK,   "Große Hütte"},
    {TR_BUILDING_HOUSE_SMALL_HOVEL,   "Kleines Haus"},
    {TR_BUILDING_HOUSE_LARGE_HOVEL,   "Großes Haus"},
    {TR_BUILDING_HOUSE_SMALL_CASA,    "Kleine Casa"},
    {TR_BUILDING_HOUSE_LARGE_CASA,    "Große Casa"},
    {TR_BUILDING_HOUSE_SMALL_INSULA,  "Kleine Insula"},
    {TR_BUILDING_HOUSE_MEDIUM_INSULA, "Mittlere Insula"},
    {TR_BUILDING_HOUSE_LARGE_INSULA,  "Große Insula"},
    {TR_BUILDING_HOUSE_GRAND_INSULA,  "Herrschaftliche Insula"},
    {TR_BUILDING_HOUSE_SMALL_VILLA,   "Kleine Villa"},
    {TR_BUILDING_HOUSE_MEDIUM_VILLA,  "Mittlere Villa"},
    {TR_BUILDING_HOUSE_LARGE_VILLA,   "Große Villa"},
    {TR_BUILDING_HOUSE_GRAND_VILLA,   "Herrschaftliche Villa"},
    {TR_BUILDING_HOUSE_SMALL_PALACE,  "Kleiner Palast"},
    {TR_BUILDING_HOUSE_MEDIUM_PALACE, "Mittlerer Palast"},
    {TR_BUILDING_HOUSE_LARGE_PALACE,  "Großer Palast"},
    {TR_BUILDING_HOUSE_LUXURY_PALACE, "Luxus Palast"},
    {TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES, "Zeige Reservoirreichweite beim Bau eines Brunnens an"},
    {TR_HOTKEY_SHOW_OVERLAY_ENEMY, "Spezialkarten Feinde"},
    {TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE, "Die Karawanserai hat Arbeiter und Essen aber die es ist zu wenig um alle Karawanen zu versorgen."},
    {TR_BUILDING_LIGHTHOUSE_NO_TIMBER, "Die Leuchturmwärter können nicht genug Holz finden um das Feuer am Leben zu halten. Die Schiffe, die Ihre Küsten entlang segeln, suchen vergeblich nach dem wegweisenden Licht."},
    {TR_EDITOR_SCENARIO_EVENTS_SET_TO_GROUP, "Füge Ausgewählte einer Gruppe hinzu..."},
    {TR_EDITOR_SCENARIO_SELECT_CONDITION, "Wähle Bedingung aus"},
    {TR_EDITOR_SCENARIO_SELECT_ACTION, "Wähle Aktion aus"},
    {TR_TOOLTIP_DEPOT_MOVED, "Sendet Resource:"},
    {TR_TOOLTIP_DEPOT_ORDER_TO, "zu"},
    {TR_TOOLTIP_RIGHT_CLICK_TO_DECREASE, "Rechtsklick zum Verringern"},
    {TR_TOOLTIP_POPULATION_GOAL, "Bevölkerungsziel"},
    {TR_TOOLTIP_BUTTON_ACCEPT_CAESAR, "Erlaube Forderungen von hier zu nehmen"},
    {TR_TOOLTIP_BUTTON_REJECT_CAESAR, "Verbiete Forderungen von hier zu nehmen"},
    {TR_EDITOR_EARTHQUAKE_CUSTOM, "Benutzerdefiniert"},
    {TR_EDITOR_TOOL_EARTHQUAKE_POINT, "Erdbebenpunkt"},
    {TR_EDITOR_TOOL_EARTHQUAKE_CUSTOM, "Benutzerdefiniertes Erdbeben"},
    {TR_EDITOR_TOOL_EARTHQUAKE_REMOVE, "Erdbeben löschen"},
    {TR_ACTION_TYPE_CHANGE_MODEL_DATA, "Ändere Model Daten"},
    {TR_PARAMETER_MODEL, "Model"},
    {TR_PARAMETER_DATA_TYPE, "Datentyp"},
    {TR_PARAMETER_COST, "Kosten"},
    {TR_PARAMETER_DESIRABILITY_VALUE, "Attraktivitäts Wert"},
    {TR_PARAMETER_DESIRABILITY_STEP, "Attraktivitäts Schritt"},
    {TR_PARAMETER_DESIRABILITY_STEP_SIZE, "Attraktivitäts Schrittgröße"},
    {TR_PARAMETER_DESIRABILITY_RANGE, "Attraktivitäts Reichweite"},
    {TR_PARAMETER_LABORERS, "Arbeiter"},
    {TR_PARAMETER_SET, "Setze"},
    {TR_PARAMETER_CHANGE, "Ändere"},
    {TR_PARAMETER_OF, "von"},
    {TR_PARAMETER_TO, "auf"},
    {TR_PARAMETER_BY, "um"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_SELL, "Resourcen (Verkauft)"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_BUY, "Resourcen (Gekauft)"},
    {TR_CHEAT_CHANGE_WEATHER, "Wetter geändert"},
    {TR_EDITOR_MODEL_DATA_DES_VALUE, "ATT"},
    {TR_EDITOR_MODEL_DATA_DES_STEP, "SRT"},
    {TR_EDITOR_MODEL_DATA_DES_STEP_SIZE, "GRß"},
    {TR_EDITOR_MODEL_DATA_DES_RANGE, "REW"},
    {TR_BUILDING_INFO_REPAIR_BUILDING, "Repariere Gebäude"},
    {TR_WARNING_REPAIR_IMPOSSIBLE, "Unmöglich diese Gebäude zu reparieren"},
    {TR_WARNING_REPAIR_BURNING, "Unmöglich diese Gebäude zu reparieren solange es brennt"},
    {TR_BUILDING_INFO_BUILDING_BURNING, "Gebäude brennt"},
    {TR_BUILDING_LAND_REPAIR, "Fläche Reparieren"},
    {TR_BUILDING_LAND_CLEAR, "Fläche Planieren"},
    {TR_CONFIRM_REPAIR_BUILDINGS, "Repariere alle Gebäude in dieser Gegend für"},
    {TR_CONFIRM_REPAIR_BUILDINGS_TITLE, "Repariere Gebäude"},
    {TR_CHEAT_DESTROYED_BUILDING, "Gebäude zerstört"},
    {TR_EMPIRE_TOOL_OUR_CITY, "Unsere Stadt"},
    {TR_EMPIRE_TOOL_TRADE_CITY, "Handelsstadt"},
    {TR_EMPIRE_TOOL_ROMAN_CITY, "Römische Stadt"},
    {TR_EMPIRE_TOOL_VULNERABLE_CITY, "Verletzliche Stadt"},
    {TR_EMPIRE_TOOL_FUTURE_TRADE_CITY, "Zukünfts Handelsstadt"},
    {TR_EMPIRE_TOOL_DISTANT_CITY, "Ferne Stadt"},
    {TR_EMPIRE_TOOL_BORDER, "Grenzflagge"},
    {TR_EMPIRE_TOOL_BATTLE, "Schlacht"},
    {TR_EMPIRE_TOOL_DISTANT_BABARIAN, "Barbaren"},
    {TR_EMPIRE_TOOL_DISTANT_LEGION, "Legion"},
    {TR_EMPIRE_TOOL_SELECT, "Auswählen"},
    {TR_HOTKEY_EDITOR_EMPIRE_DELETE_OBJECT, "Objekt löschen"},
    {TR_PARAMETER_BUYING, "Kauf ändern"},
    {TR_EDITOR_DEMAND_CHANGE_BUYS, "kaufend"},
    {TR_EDITOR_DEMAND_CHANGE_SELLS, "verkaufend"},
    {TR_EDITOR_VIEW_CURRENT_EMPIRE, "Aktuelles Imperium ansehen"},
    {TR_EDITOR_CREATE_NEW_EMPIRE, "Neues Imperium erstellen"},
    {TR_CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT, "Schlaue Grenzplatzierung"},
    {TR_CONFIG_CATEGORY_UI_EMPIRE, "Imperium"},
    {TR_EDITOR_CUSTOM_EMPIRE_TITLE_SAVE, "Imperium sichern"},
    {TR_EDITOR_EMPIRE_EXPORT, "Exportieren"},
    {TR_EDITOR_EMPIRE_IMPORT, "Importieren"},
    {TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS, "Baumenüabkürzungen aktivieren"},
    {TR_EDITOR_CURRENT_ICON, "Aktuelles Stadticon"},
    {TR_EMPIRE_CITY_ICON_DEFAULT, "Kein Icon"},
    {TR_EMPIRE_CITY_ICON_CONSTRUCTION, "Im Bau"},
    {TR_EMPIRE_CITY_ICON_DISTANT_TOWN, "Ferne Kleinstadt"},
    {TR_EMPIRE_CITY_ICON_DISTANT_VILLAGE, "Fernes Dorf"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_FOOD, "Resourcen Nahrung"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_GOODS, "Resourcen Güter"},
    {TR_EMPIRE_CITY_ICON_RESOURCE_SEA, "Resourcen Meer"},
    {TR_EMPIRE_CITY_ICON_TRADE_TOWN, "Handelskleinstadt"},
    {TR_EMPIRE_CITY_ICON_ROMAN_TOWN, "Römische Kleinstadt"},
    {TR_EMPIRE_CITY_ICON_TRADE_VILLAGE, "Handelsdorf"},
    {TR_EMPIRE_CITY_ICON_ROMAN_VILLAGE, "Römisches Dorf"},
    {TR_EMPIRE_CITY_ICON_ROMAN_CAPITAL, "Hauptstadt"},
    {TR_EMPIRE_CITY_ICON_TRADE_SEA, "Seehandel"},
    {TR_EMPIRE_CITY_ICON_TRADE_LAND, "Landhandel"},
    {TR_EMPIRE_CITY_ICON_OUR_CITY, "Unsere Stadt"},
    {TR_EMPIRE_CITY_ICON_TRADE_CITY, "Handelsstadt"},
    {TR_EMPIRE_CITY_ICON_ROMAN_CITY, "Römische Stadt"},
    {TR_EMPIRE_CITY_ICON_DISTANT_CITY, "Ferne Stadt"},
    {TR_EMPIRE_CITY_ICON_TOWER, "Turm"},
    {TR_ACTION_TYPE_LOCK_TRADE_ROUTE, "Handelsroute schließen"},
    {TR_PARAMETER_LOCK, "Schließen"},
    {TR_PARAMETER_UNLOCK, "Öffnen"},
    {TR_EMPIRE_DELETE_OBJECT, "Objekt löschen"},
    {TR_EMPIRE_MOVE_OBJECT, "Objekt bewegen"},
    {TR_CONFIG_UI_EMPIRE_CLICK_TO_DELETE, "Klicken müssen um Objekt zu löschen"},
    {TR_PARAMETER_TERRAIN_RUBBLE, "Ruinen"},
    {TR_EMPIRE_DRAW_TRADE_ROUTE, "Route erstellen"},
    {TR_CONFIG_UI_EMPIRE_CONFIRM_DELETE, "Entfernung des Objekts bestätigen"},
    {TR_EMPIRE_TOOL_LAND_ROUTE, "Landhandelsroute"},
    {TR_EMPIRE_TOOL_SEA_ROUTE, "Seahandelsroute"},
    {TR_EMPIRE_TOGGLE_EDGES, "Ecken umschalten"},
    {TR_EMPIRE_EDGE_INDEX, "Grenzflagge Nr."},
    {TR_EMPIRE_WAYPOINT_INDEX, "Wegpunkt Nr."},
    {TR_EMPIRE_ROUTE_PARENT, "von"},
    {TR_EMPIRE_ORNAMENT_STONEHENGE, "Stonehenge"},
    {TR_EMPIRE_ORNAMENT_GALLIC_WHEAT, "Gallisches Weizen"},
    {TR_EMPIRE_ORNAMENT_THE_PYRENEES, "Die Pyrenäen"},
    {TR_EMPIRE_ORNAMENT_IBERIAN_AQUEDUCT, "Iberisches Aquädukt"},
    {TR_EMPIRE_ORNAMENT_TRIUMPHAL_ARCH, "Triumphbogen"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_WHEAT, "West Wüsten Weizen"},
    {TR_EMPIRE_ORNAMENT_LIGHTHOUSE_ALEXANDRIA, "Leuchtturm Alexandrias"},
    {TR_EMPIRE_ORNAMENT_WEST_DESERT_PALMS, "West Wüsten Palmen"},
    {TR_EMPIRE_ORNAMENT_TRADE_SHIP, "Handelsschiff"},
    {TR_EMPIRE_ORNAMENT_WATERSIDE_PALMS, "Küstenpalmen"},
    {TR_EMPIRE_ORNAMENT_THE_COLOSSEUM, "Das Kolloseum"},
    {TR_EMPIRE_ORNAMENT_THE_ALPS, "Die Alpen"},
    {TR_EMPIRE_ORNAMENT_ROMAN_TREE, "Römischer Baum"},
    {TR_EMPIRE_ORNAMENT_GREEK_MOUNTAINS, "Griechische Gebirgskette"},
    {TR_EMPIRE_ORNAMENT_THE_PARTHENON, "Das Parthenon"},
    {TR_EMPIRE_ORNAMENT_THE_PYRAMIDS, "Die Pyramiden"},
    {TR_EMPIRE_ORNAMENT_HAGIA_SOPHIA, "Hagia Sophia"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_PALMS, "Ost Wüsten Palmen"},
    {TR_EMPIRE_ORNAMENT_EAST_DESERT_WHEAT, "Ost Wüsten Weizen"},
    {TR_EMPIRE_ORNAMENT_TRADE_CAMEL, "Handelskamel"},
    {TR_EMPIRE_ORNAMENT_MOUNT_ETNA, "Ätna"},
    {TR_EMPIRE_ORNAMENT_COLOSSUS_RHODES, "Der Koloss von Rhodos"},
    {TR_EMPIRE_ORNAMENT_THE_TEMPLE, "Der Tempel"},
    {TR_EMPIRE_BATTLE_PARENT, "des Pfads"},
    {TR_EDITOR_EMPIRE_PROPERTIES, "Eigenschaften"},
    {TR_EDITOR_IMAGE_IMPORT, "Bild importieren"},
    {TR_EDITOR_UNABLE_TO_SET_EMPIRE_IMAGE, "Bild kann nicht gesetzt werden"},
    {TR_EDITOR_IMAGE_TO_SMALL, "Bild zu klein"},
    {TR_EDITOR_IMAGE_TO_SMALL_EXPLANATION, "Das Bild ist so klein, dass es den Imperiumseditor verbuggen würde. Willst du es dennoch laden?"},
    {TR_EDITOR_EMPIRE_PROPERTIES_SELECT_IMAGE, "Hintergrundbild wählen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_DEFAULT_IMAGE, "Standart Bild"},
    {TR_EDITOR_EMPIRE_PROPERTIES_SETTINGS, "Imperiums Einstellungen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_HOTKEYS, "Imperiums Hotkeys"},
    {TR_EDITOR_EMPIRE_PROPERTIES_BORDER_DENSITY, "Grenzdichte ändern"},
    {TR_EDITOR_EMPIRE_PROPERTIES_NEW_PATH, "Invasionspfad ändern"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ADD_ORNAMENT, "Ornament hinzufügen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ALL_ORNAMENTS, "Alle Ornamente hinzufügen"},
    {TR_EMPIRE_TOOLTIP_EDIT_NAME, "Stadtnamen ändern"},
    {TR_EMPIRE_TOOLTIP_ADD_RESOURCE, "Resource hinzufügen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_ALL_CITIES, "Alle Städte hinzufügen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_IRELAND, "Irland umschalten"},
    {TR_EMPIRE_TOOLTIP_ROUTE_TYPE, "Handelsroutentyp ändern"},
    {TR_EMPIRE_TOOLTIP_AFTER_ICON, "Ändere Icon nach der Konversion\nAktuelles Icon:"},
    {TR_EMPIRE_TOOL_PICK, "Werkzeug kopieren"},
    {TR_EMPIRE_TOOLTIP_SHOW_TOOLS, "Alle Werkzeuge anzeigen"},
    {TR_EMPIRE_TOOLTIP_ROUTE_COST, "Handelroutenkosten ändern"},
    {TR_RESOURCE_SETTINGS_IN_GRANARIES, "in Silos"},
    {TR_CONFIG_HEADER_WATER_STRUCTURE_RANGE, "Zeige Reichweite von Brunnen und Ziehbrunnen"},
    {TR_CONFIG_GP_CH_AUTO_CLEAR_TREES, "Planiere automatisch Bäume und Gebüsch beim Platzieren von Gebäuden"},
    {TR_WARNING_OPEN_WATER_NEEDED_FOR_BUILDING, "Das Gebäude muss nahe offenem Wasser platziert werden"},
    ...
    {TR_BUILDING_HIGHWAY_STATION_NOT_FUNCTIONAL, "Die Wegewarte ist nicht funktional. Die Straßen kosten so viel wie immer."},
    {TR_BUILDING_HIGHWAY_STATION_MONTHLY_NEED, "Monatlicher Konsum (je Resource):"},
    {TR_BUILDING_HIGHWAY_STATION_HIGHWAY_TILES, "Schnellstraßen in der Stadt:"},
    {TR_BUILDING_HIGHWAY_STATION_STONE_STOCK, "Gelagerter Stein,"},
    {TR_BUILDING_HIGHWAY_STATION_SAND_STOCK, "Gelagerter Sand,"},
    {TR_TOOLTIP_BUTTON_HIGHWAY_STATION, "Wegewarte"},
    {TR_WARNING_HIGHWAY_STATION_NEEDS_SENATE, "Ein Arbeiterlager muss zuerst gebaut werden."},
    {TR_WARNING_DEPOT_RECALL_ALL, "Alle Oxen zurückgerufen!"},
    ...
    {TR_TOOLTIP_DEPOT_CLEAR_DST, "Zielort löschen"},
    {TR_CONFIG_HEADER_RAIN, "Regen"},
    {TR_CONFIG_HEADER_SNOW, "Schnee"},
    {TR_CONFIG_HEADER_SAND, "Sandsturm"},
    {TR_CONFIG_HEADER_EMPIRE_EDITOR, "Imperiums Editor"},
    {TR_CONFIG_UI_WT_PREVIEW_RAIN, "Regen-Vorschau anzeigen"},
    {TR_CONFIG_UI_WT_PREVIEW_SNOW, "Schnee-Vorschau anzeigen"},
    {TR_CONFIG_UI_WT_PREVIEW_SANDSTORM, "Sandstrum-Vorschau anzeigen"},
    {TR_CONFIG_UI_WT_PREVIEW_HEAVY_RAIN, "Vorschau heftigen Regens anzeigen"},
    {TR_CONFIG_WT_RAIN_SPEED, "Regentropfengeschwindigkeit"},
    {TR_CONFIG_WT_RAIN_LENGTH, "Regentropfengröße"},
    {TR_CONFIG_WT_RAIN_INTENSITY, "Bedeckungsstärke"},
    {TR_CONFIG_WT_SNOW_INTENSITY, "Bedeckungsstärke"},
    {TR_CONFIG_WT_SANDSTORM_INTENSITY, "Bedeckungsstärke"},
    {TR_CONFIG_WT_SANDSTORM_SPEED, "Sandgeschwindigkeit"},
    {TR_CONFIG_WT_SANDSTORM_SIZE, "Sandpartikelgröße"},
    {TR_CONFIG_WT_SNOW_SPEED, "Schneeflockengeschwindigkeit"},
    {TR_CONFIG_WT_SNOWFLAKE_SIZE, "Schneeflockengröße"},
    {TR_CONFIG_WT_SIZE_MINIMUM, "Minimum"},
    {TR_CONFIG_WT_SIZE_SMALL, "Klein"},
    {TR_CONFIG_WT_SIZE_REGULAR, "Normal"},
    {TR_CONFIG_WT_SIZE_LARGE, "Groß"},
    {TR_CONFIG_WT_SIZE_MAXIMUM, "Maximum"},
    {TR_CONFIG_WT_SPEED_SLOW, "Langsam"},
    {TR_CONFIG_WT_SPEED_FAST, "Schnell"},
    {TR_CONFIG_WT_WEATHER_DURATION, "Wetterdauer"},
    {TR_CONFIG_WT_DURATION_SHORT, "Kurz"},
    {TR_CONFIG_WT_DURATION_REGULAR, "Normal"},
    {TR_CONFIG_WT_DURATION_LONG, "Lang"},
    {TR_ADVISOR_HEALTH_WATER_COVERAGE, "Wasser"},
    {TR_ADVISOR_HEALTH_HEALTH_COVERAGE, "Gesundheit"},
    {TR_BUILDING_FOUNTAINS, "Brunnen"},
    {TR_BUILDING_WELLS, "Ziehbrunnen"},
    {TR_BUILDING_LATRINE, "Latrinen"},
    {TR_ADVISOR_CHIEF_WATER_COVERAGE, "Wasserversorgung"},
    {TR_ADVISOR_CHIEF_CLEAN_WATER, "Ein Großteil Ihrer Bevölkerung hat Zugang zu dem klaren Wasser eines Brunnens."},
    {TR_ADVISOR_CHIEF_LATRINE_AND_WELL, "Ein Großteil Ihrer Bevölkerung hat Zugang zu einem Ziehbrunnen und einer Latrine."},
    {TR_ADVISOR_CHIEF_WELL_WATER, "Die meisten Bewohner Ihrer Stadt müssen ihr Wasser aus Ziehbrunnen schöpfen."},
    {TR_ADVISOR_CHIEF_NO_WATER, "Die meisten Bewohner Ihrer Stadt haben keinen vernünftigen Zugang zu Trinkwasser."},
    {TR_TOOLTIP_OVERLAY_PROBLEMS_DEPOT_NO_INSTRUCTIONS, "Keine Anweisungen"},
    {TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS, "Silos erlauben standartmäßig keine Fußgänger"},
    {TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS, "Lagerhäuser erlauben standartmäßig keine Fußgänger"},
    {TR_EDITOR_SCENARIO_CHANGE_MODEL_DATA, "Ändere Model Daten"},
    {TR_EDITOR_PRICE_CHANGE, "Preisänderung"},
    {TR_EDITOR_PRICE_CHANGES, "Preisänderungen"},
    {TR_EDITOR_DEMAND_CHANGE, "Nachfragenänderung"},
    {TR_EDITOR_DEMAND_CHANGES, "Nachfragenänderungen"},
    {TR_WINDOW_ADVISOR_EPITHETS, "Kräfte der Götter"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP, "Von Prachttempeln verliehene göttliche Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_CERES, "Ceres' Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_NEPTUNE, "Neptuns Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_MERCURY, "Merkurs Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_MARS, "Mars' Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_VENUS, "Venus' Kräfte"},
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP_PANTHEON, "Kräfte des Pantheons"},
    {TR_FIGURE_TYPE_PLEBIAN, "Plebejer"},
    {TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_PLEBIANS, "Häuser erstellen keine kosmetischen Plebejer"},
    {TR_BUILDING_DEPOTS, "Karren-Depots:"},
    {TR_DESTRIBUTION_SOURCE, "- als Quelle benutzt:"},
    {TR_DESTRIBUTION_DESTINATION, "- als Zielort benutzt"},
    {TR_FIGURE_TYPE_DOG, "Hund"},
    {TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_DOGS, "Häuser erstellen keine kosmetischen Hunde"},
    {TR_CONFIG_HEADER_DESIRABILITY, "Attraktivität"},
    ...
    {TR_CONFIG_UI_CLIMATE_GRID_COLORS, "Terrain basierte Farben des Baurasters"},
    {TR_ACTION_TYPE_CHANGE_HOUSE_MODEL_DATA, "Ändere Häuser Model Daten"},
    {TR_PARAMETER_DEVOLVE_DESIRABILITY, "Absteigeattraktivität"},
    {TR_PARAMETER_EVOLVE_DESIRABILITY, "Aufsteigeattraktivität"},
    {TR_PARAMETER_ENTERTAINMENT, "Unterhaltung"},
    {TR_PARAMETER_WATER, "Wasser"},
    {TR_PARAMETER_RELIGION, "Religion"},
    {TR_PARAMETER_EDUCATION, "Bildung"},
    {TR_PARAMETER_BARBER, "Barbier"},
    {TR_PARAMETER_BATHHOUSE, "Badehaus"},
    {TR_PARAMETER_HEALTH, "Gesundheit"},
    {TR_PARAMETER_FOOD_TYPES, "Nahrungsmittelarten"},
    {TR_PARAMETER_POTTERY, "Geschirr"},
    {TR_PARAMETER_FURNITURE, "Möbel"},
    {TR_PARAMETER_OIL, "Öl"},
    {TR_PARAMETER_WINE, "Wein"},
    {TR_PARAMETER_PROSPERITY, "Wohlstand"},
    {TR_PARAMETER_MAX_PEOPLE, "Max. Einwohner"},
    {TR_PARAMETER_TAX_MULTIPLIER, "Steuermultiplikator"},
    {TR_PARAMETER_TYPE_HOUSING_TYPE, "Hauslevel"},
    {TR_PARAMETER_BUILDING_MODEL_REST_CONFIRMATION, "Dies setzt nur Gebäude Model Daten zurück."},
    {TR_PARAMETER_HOUSE_MODEL_REST_CONFIRMATION, "Dies setzt nur Haus Model Daten zurück."},
    {TR_EDITOR_HOUSE_MODEL_DEVOLVE_DESIRABILITY, "ABA"},
    {TR_EDITOR_HOUSE_MODEL_EVOLVE_DESIRABILITY, "AFA"},
    {TR_EDITOR_HOUSE_MODEL_ENTERTAINMENT, "UTH"},
    {TR_EDITOR_HOUSE_MODEL_WATER, "WAS"},
    {TR_EDITOR_HOUSE_MODEL_RELIGION, "RLG"},
    {TR_EDITOR_HOUSE_MODEL_EDUCATION, "BLD"},
    {TR_EDITOR_HOUSE_MODEL_BARBER, "BAR"},
    {TR_EDITOR_HOUSE_MODEL_BATHHOUSE, "BDH"},
    {TR_EDITOR_HOUSE_MODEL_HEALTH, "GSH"},
    {TR_EDITOR_HOUSE_MODEL_FOOD_TYPES, "NMA"},
    {TR_EDITOR_HOUSE_MODEL_POTTERY, "GES"},
    {TR_EDITOR_HOUSE_MODEL_FURNITURE, "MÖB"},
    {TR_EDITOR_HOUSE_MODEL_OIL, "ÖL"},
    {TR_EDITOR_HOUSE_MODEL_WINE, "WEN"},
    {TR_EDITOR_HOUSE_MODEL_PROSPERITY, "WLS"},
    {TR_EDITOR_HOUSE_MODEL_MAX_PEOPLE, "MEW"},
    {TR_EDITOR_HOUSE_MODEL_TAX_MULTIPLIER, "SMP"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_DEVOLVE_DESIRABILITY, "Absteigeattraktivität\\nDie Attraktivität, die unterschritten werden muss, damit das Haus absteigt"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_EVOLVE_DESIRABILITY, "Aufsteigeattraktivität\\nDie Attraktivität, die überschritten werden muss, damit das Haus aufsteigen kann"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_ENTERTAINMENT, "Unterhaltung\\nDer Unterhaltungswert beötigt\\nz.B. 10 ist der Wert, den ein Theater gibt."},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_WATER, "Wasser\\nDas Wasserlevel, das benötigt wird\\n0: Keins, 1 = Ziehbrunnen, 2 = Ziehbrunnen + Latrine, 3 = Brunnen"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_RELIGION, "Religion\\nAnzahl unterschiedlicher Götter zu denen das Haus Zugang braucht"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_EDUCATION, "Bildung\\nBildungseinrichtungen benötigt\\n0: Keine, 1 = Schule oder Bibilothek, 2 = Schule und Bibilothek, 3 = Schule, Bibilothek und Academy"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_BARBER, "Barbier\\nOb das Haus einen Barbier braucht 0 oder 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_BATHHOUSE, "Badehaus\\nOb das Haus ein Badehaus braucht 0 oder 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_HEALTH, "Gesundheit\\nGesundheitseinrichtungen benötigt\\n1 = Klinik oder Krankenhaus, 2 = Klinik und Krankenhaus"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_FOOD_TYPES, "Nahrungsmittelarten\\nDie Anzahl unterschiedlicher Lebensmittel benötigt"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_POTTERY, "Geschirr\\nOb das Haus Geschirr braucht 0 oder 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_FURNITURE, "Möbel\\nOb das Haus Möbel braucht 0 oder 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_OIL, "Öl\\nOb das Haus Öl braucht 0 oder 1"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_WINE, "Wein\\nDie Anzahl an Weinsorten benötigt"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_PROSPERITY, "Wohlstand\\nDie Wohlstandspunkte, die das Haus zur globalen Wohlstandsobergrenze beiträgt"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_MAX_PEOPLE, "Max. Einwohner\\nWie viele Leute in dem Haus leben können"},
    {TR_EDITOR_HOUSE_MODEL_EXPLANATION_TAX_MULTIPLIER, "Steuermultiplikator\\nEin Multiplikator für Steuern"},
    {TR_ACTION_TYPE_CHANGE_GOAL, "Ändere Siegkriterien"},
    {TR_PARAMETER_TYPE_WIN_CONDITION, "Kriterium"},
    {TR_SCENARIO_WIN_CONDITION_CULTURE, "Kultur"},
    {TR_SCENARIO_WIN_CONDITION_PROSPERITY, "Wohlstand"},
    {TR_SCENARIO_WIN_CONDITION_PEACE, "Frieden"},
    {TR_SCENARIO_WIN_CONDITION_FAVOR, "Gunst"},
    {TR_SCENARIO_WIN_CONDITION_LOOSING_TIME, "Zeitlimit"},
    {TR_SCENARIO_WIN_CONDITION_WINNING_TIME, "Überlebenszeit"},
    {TR_SCENARIO_WIN_CONDITION_POPULATION, "Bevölkerung"},
    {TR_EDITOR_COPY, "Kopieren"},
    {TR_EDITOR_PASTE, "Einfügen"},
    {TR_EDITOR_SCENARIO_EVENTS_COPY_SELECTED, "Ausgewählt kopieren"},
    {TR_EDITOR_SCENARIO_EVENTS_PASTE_SELECTED, "Ausgewählt einfügen"},
    {TR_UI_TRADE_LEDGER_HEADER, "Handelsratgeber"},
    {TR_CONDITION_TYPE_ENEMIES_IN_CITY, "Gegner in der Stadt"},
    {TR_CONDITION_TYPE_LAND_TRADE_PROBLEMS, "Landhandelsproblemdauer"},
    {TR_CONDITION_TYPE_SEA_TRADE_PROBLEMS, "Seehandelsproblemdauer"},
    {TR_BUILDING_FOURTH_FOODTYPE_MISSING_EVOLVE, "Dieses Haus kann nicht aufstiegen, da es eine vierte Art an Lebensmitteln braucht von einem Markt braucht."},
    {TR_BUILDING_FOURTH_FOODTYPE_MISSING_DEVOLVE, "Dieses Haus wird bald absteigen, da es momentan nur Zugang zu 3 Arten an Lebensmitteln hat."},
    {TR_BUILDING_FIFTH_FOODTYPE_MISSING_EVOLVE, "Dieses Haus kann nicht aufstiegen, da es eine fünfte Art an Lebensmitteln braucht von einem Markt braucht."},
    {TR_BUILDING_FIFTH_FOODTYPE_MISSING_DEVOLVE, "Dieses Haus wird bald absteigen, da es momentan nur Zugang zu 4 Arten an Lebensmitteln hat."},
    {TR_ACTION_TYPE_MOVE_CAMERA, "Kamera bewegen"},
    {TR_ACTION_TYPE_CHANGE_WEATHER, "Wetter ändern"},
    {TR_PARAMETER_INTENSITY, "Intensität"},
    {TR_PARAMETER_TYPE_WEATHER, "Wettertyp"},
    {TR_PARAMETER_CLEAN_WEATHER, "Klar"},
    {TR_CITY_PROPERTY_OPENED_ROUTES, "Geöffnete Handelsrouten"},
    {TR_PARAMETER_TYPE_ROUTE_TYPE, "Routentyp"},
    {TR_PARAMETER_ROUTE_TYPE_ALL, "Alle"},
    {TR_PARAMETER_ROUTE_TYPE_LAND, "Land"},
    {TR_PARAMETER_ROUTE_TYPE_SEA, "See"},
    {TR_EMPIRE_CITY_ICON_BUTTON, "Knopf"},
    {TR_BUILDING_FOURTH_GOOD_MISSING_EVOLVE, "Dieses Haus kann nicht aufsteigen, da es nur Zugang zu Tempeln dreier Götter hat. So Einwohner wohlhabender werden, wünschen sie sich mehr Zeit mit dem Anbeten von Göttern zu verbringen."},
    {TR_BUILDING_FOURTH_GOOD_MISSING_DEVOLVE, "Dieses Haus wird bald absteigen. Seine vorherigen exzellenten religiösen Einrichtungen wurden auf nur drei Götter eingeschränkt."},
    {TR_BUILDING_FIFTH_GOOD_MISSING_EVOLVE, "Dieses Haus kann nicht aufsteigen, da es nur Zugang zu Tempeln vierer Götter hat. So Einwohner wohlhabender werden, wünschen sie sich mehr Zeit mit dem Anbeten von Göttern zu verbringen."},
    {TR_BUILDING_FIFTH_GOOD_MISSING_DEVOLVE, "Dieses Haus wird bald absteigen. Seine vorherigen exzellenten religiösen Einrichtungen wurden auf nur vier Götter eingeschränkt."},
    {TR_EDITOR_SCENARIO_CHANGE_HOUSE_MODEL_DATA, "Ändere Haus Model Daten"},
    {TR_ACTION_TYPE_HIDE_TRADE_ROUTE, "Handelsroute verstecken"},
    {TR_PARAMETER_HIDE, "Verstecken"},
    {TR_EMPIRE_HIDE_TRADE_ROUTE, "Route Verstecken"},
    {TR_EMPIRE_SHOW_TRADE_ROUTE, "Route zeigen"},
    {TR_EMPIRE_HIDE_EDGE, "Verstecken"},
    {TR_EMPIRE_SHOW_EDGE, "Zeigen"},
    {TR_ACTION_TYPE_CHANGE_VARIABLE_COLOR, "Ändere die Farbe der Variable"},
    {TR_CONDITION_TYPE_MONTHS_SINCE_FESTIVAL, "Monate seit letztem Fest"},
    {TR_EMPIRE_VULNERABLE_CITY, "Verwundbare Stadt"},
    {TR_CONFIG_UI_EDITOR_SHOW_DELETION_WARNINGS, "Zeige Warnungen beim Löschen von Ereignissen, Bedingungen oder Aktionen"},
    {TR_CATEGORY_UI_EDITOR, "Editor"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TITLE, "Ereignisse löschen?"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TEXT, "Sind Sie sicher, dass sie diese Ereignisse löschen wollen?\\n\\nDiese Aktion ist unwiederrufbar."},
    {TR_CONDITION_TYPE_DESIRABILITY_IN_AREA, "Attraktivität in Gegend"},
    {TR_CONDITION_TYPE_POPULATION_IN_AREA, "Bevölkerung in Gegend"},
    {TR_PARAMETER_AGE_SCHOOL, "Schulalter (0-14)"},
    {TR_PARAMETER_AGE_ACADEMY, "Akademiealter(14-21)"},
    {TR_PARAMETER_AGE_WORKING, "Arbeitsalter (20-49/59)"},
    {TR_PARAMETER_AGE_RETIRED, "Rentner (50+/60+)"},
    {TR_EDITOR_MODEL_DATA_DEFAULT, "Standart:"},
    {TR_ACTION_TYPE_IMMIGRATION_PERCENTAGE, "Ändere Migrationsgeschwindigkeit"},
    {TR_PARAMETER_IMMIGRATION, "Ändere Einwanderung"},
    {TR_CHEAT_CHANGED_MONUMENT_RESOURCES, "Resourcen benötigt für Monumenttyp geändert"},
    {TR_ACTION_TYPE_CHANGE_MONUMENT_RESOURCES, "Ändere Resourcen benötigt für Monumenttyp"},
    {TR_PARAMETER_TYPE_MONUMENT, "Monumenttyp"},
    {TR_PARAMETER_MONUMENT_STAGE, "Phase"},
    {TR_RESOURCE_ARCHITECTS, "Architekten"},
    {TR_ACTION_TYPE_RENAME_CITY, "Ändere Stadtname"},
    {TR_PARAMETER_TYPE_CITY, "Stadt"},
    {TR_PARAMETER_NAME, "Name"},
    {TR_CONFIG_UI_AUTO_DELETE_OLD_COMMON_MESSAGES, "Lösche normale Nachrichten automatisch nach 5 Jahren"},
    {TR_UI_CURRENT_YEAR, "Momentanes Jahr"},
    {TR_UI_HIDE_IRRELEVANT_RESOURCES, "Verstecke irrelevante Resourcen"},
    {TR_UI_YEAR_AGO, "Jahr zuvor"},
    {TR_UI_YEARS_AGO, "Jahre zuvor"},
    {TR_UI_LAST_YEAR, "Letztes Jahr"},
    {TR_UI_SELECT_TRADE_LEDGER_YEAR, "Jahr wählen"},
    {TR_UI_TRADE_LEDGER_OPEN, "Offen"},
    {TR_UI_TRADE_LEDGER_CLOSED, "Geschlossen"},
    {TR_UI_TRADE_LEDGER_BOTH, "Offen/Geschlossen"},
    {TR_UI_TRADE_LEDGER_TRADES, "Handelt"},
    {TR_UI_TRADE_LEDGER_BUYS, "Kauft"},
    {TR_UI_TRADE_LEDGER_SELLS, "Verkauft"},
    {TR_UI_TOOLTIP_CLEAR_SELECTION, "Lösche Auswahl"},
    {TR_UI_TOOLTIP_SELECT_RESOURCE_FILTER, "Resource wählen"},
    {TR_UI_TOOLTIP_RESET_SORTING, "Sortierung zurücksetzen"},
    {TR_UI_TOOLTIP_SELECT_SORTING, "Sortierung wählen"},
    {TR_UI_TOOLTIP_RESET_FILTERS, "Filter zurücksetzen"},
    {TR_UI_TOOLTIP_SHOW_ALL_ROUTE_TYPES, "Zeige alle Routentypen"},
    {TR_UI_TOOLTIP_SHOW_LAND_ROUTES, "Zeige alle Landrouten"},
    {TR_UI_TOOLTIP_SHOW_SEA_ROUTES, "Zeige alle Seerouten"},
    {TR_UI_TOOLTIP_SHOW_OPEN_AND_CLOSED_ROUTES, "Zeige Offene und Geschlossene"},
    {TR_UI_TOOLTIP_SHOW_OPEN_ROUTES, "Zeige offene Routen"},
    {TR_UI_TOOLTIP_SHOW_CLOSED_ROUTES, "Zeige geschlossene Routen"},
    {TR_UI_TOOLTIP_SELECT_CITY_RESOURCE_TRADE, "Wähle Resourcenfilter"},
    {TR_UI_TOOLTIP_OPEN_TRADE_LEDGER, "Handelsratgeber öffnen"},
    {TR_UI_SIDEBAR_TRADE_HISTORY, "Handelshistorie"},
    {TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP, "Handelsbericht des ausgewählt Jahres ansehen"},
    {TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP_LOST, "Ihre Schreiber halten ihre Berichte nicht so lang!"},
    {TR_UI_LEDGER_BTN_IMPORTED, "Imp"},
    {TR_UI_LEDGER_TT_IMPORTED, "Nach importiert sortieren"},
    {TR_UI_LEDGER_BTN_PRODUCED, "Pro"},
    {TR_UI_LEDGER_TT_PRODUCED, "Nach produziert sortieren"},
    {TR_UI_LEDGER_BTN_CONSUMED, "Kon"},
    {TR_UI_LEDGER_TT_CONSUMED, "Nach konsumiert sortieren"},
    ...
    {TR_CONFIG_UI_SCROLL_CAMERA_UNLOCKED, "Kameragrenzen erweitern"},
    {TR_UI_LEDGER_ONLY_CURRENT_YEAR, "Sie haben das Gouvaneursein erst dieses Jahr begonnen"},
    {TR_EMPIRE_TOOLTIP_ROUTE_COST_HELP, "Rechtsclick: Erweiterte Kostenoptionen"},
    {TR_EMPIRE_ROUTE_COST, "Handelsroute Kosten:"},
    {TR_EMPIRE_RESOURCE_COST, "Resourcen benötigt zum Öffnen"},
    {TR_EMPIRE_COSTS, "Kostet"},
    {TR_EMPIRE_NO_RESOURCES_TITLE, "Resourcen fehlen"},
    {TR_EMPIRE_NO_RESOURCES_TEXT, "Sie haben nicht genügend Resourcen, um die Route zu öffnen.\\n Stellen Sie sicher, dass Ihre Industrien genug Arbeitskräfte haben und bauen Sie ggf. weitere, um die benötigten Resourcen zu bekommen."},
    {TR_ACTION_TYPE_CHANGE_ROUTE_RESOURCE_COST, "Ändere Handelsroutenkosten (Resourcen)"},
    {TR_ACTION_TYPE_KILL_WALKERS_IN_AREA, "Töte Wanderer in Gegend"},
    {TR_PARAMETER_TYPE_FIGURE_CATEGORY, "Kategorie"},
    {TR_PARAMETER_FIGURE_CATEGORY_INACTIVE, "Inaktiv"},
    {TR_PARAMETER_FIGURE_CATEGORY_CITIZEN, "Bürger"},
    {TR_PARAMETER_FIGURE_CATEGORY_ARMED, "Bewaffnet"},
    {TR_PARAMETER_FIGURE_CATEGORY_HOSTILE, "Feindlich"},
    {TR_PARAMETER_FIGURE_CATEGORY_CRIMINAL, "Kriminelle"},
    {TR_PARAMETER_FIGURE_CATEGORY_NATIVE, "Eingeborene"},
    {TR_PARAMETER_FIGURE_CATEGORY_ANIMAL, "Tiere"},
    {TR_PARAMETER_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Aggressive Tiere"},
    {TR_PARAMETER_FIGURE_CATEGORY_PROJECTILE, "Projektile"},
    {TR_PARAMETER_FIGURE_CATEGORY_EFFECT, "Effekt"},
    {TR_PARAMETER_FIGURE_CATEGORY_INDUSTRY, "Industrie"},
    {TR_PARAMETER_FIGURE_CATEGORY_ENTERTAINMENT, "Unterhaltung"},
    {TR_PARAMETER_FIGURE_CATEGORY_EDUCATION, "Bildung"},
    {TR_PARAMETER_FIGURE_CATEGORY_HEALTH, "Gesundheit"},
    {TR_PARAMETER_FIGURE_CATEGORY_MULTIPLE, "Mehrere"},
    {TR_PARAMETER_FIGURE_CATEGORY_NONE, "Keine"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INACTIVE, "Nicht lebendige Figuren\\n z.B. Staubwolken, Schiffe und Projektile"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CITIZEN, "Alle freundlichen Römer (Haustiere eingeschlossen)"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ARMED, "Alle Leute, die Ihre Stadt mit ihrem Leben verteidigen werden"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HOSTILE, "Alle Ihre Gegner"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CRIMINAL, "Kriminelle und Aufständische"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_NATIVE, "Eingeborene auch Friedliche"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ANIMAL, "Herdentiere"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Wölfe"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_PROJECTILE, "Projektile\\n z.B. Speere, Pfeile etc."},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EFFECT, "Kosmetische Figuren\\n z.B. Staubwolken, Möven oder Rennpferde im Hippodrom"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INDUSTRY, "Industriearbeiter\\n Viele Leute fallen in diese Kategorie"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ENTERTAINMENT, "Unterhaltungswanderer"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EDUCATION, "Bildungswanderer"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HEALTH, "Gesundheitswanderer"},
    {TR_CONDITION_TYPE_FIGURES_IN_AREA, "Anzahl an Figuren in Gegend"},
    {TR_ACTION_TYPE_SEND_CITY_WARNING, "Stadtwarnung senden"},
    {TR_PARAMETER_MESSAGE, "Nachricht"},
    {TR_PARAMETER_PLAY_FANFARE, "Fanfare spielen"},
};
