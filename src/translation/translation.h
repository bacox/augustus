...
typedef enum {
    ...
    TR_CONDITION_TYPE_ENEMIES_IN_CITY,
    TR_CONDITION_TYPE_LAND_TRADE_PROBLEMS,
    TR_CONDITION_TYPE_SEA_TRADE_PROBLEMS,
    TR_BUILDING_FOURTH_FOODTYPE_MISSING_EVOLVE,
    TR_BUILDING_FOURTH_FOODTYPE_MISSING_DEVOLVE,
    TR_BUILDING_FIFTH_FOODTYPE_MISSING_EVOLVE,
    TR_BUILDING_FIFTH_FOODTYPE_MISSING_DEVOLVE,
    TR_ACTION_TYPE_MOVE_CAMERA,
    TR_ACTION_TYPE_CHANGE_WEATHER,
    TR_PARAMETER_INTENSITY,
    TR_PARAMETER_TYPE_WEATHER,
    TR_PARAMETER_CLEAN_WEATHER,
    TR_CITY_PROPERTY_OPENED_ROUTES,
    TR_PARAMETER_TYPE_ROUTE_TYPE,
    TR_PARAMETER_ROUTE_TYPE_ALL,
    TR_PARAMETER_ROUTE_TYPE_LAND,
    TR_PARAMETER_ROUTE_TYPE_SEA,
    ...
    TR_BUILDING_FOURTH_GOOD_MISSING_EVOLVE,
    TR_BUILDING_FOURTH_GOOD_MISSING_DEVOLVE,
    TR_BUILDING_FIFTH_GOOD_MISSING_EVOLVE,
    TR_BUILDING_FIFTH_GOOD_MISSING_DEVOLVE,
    TR_EDITOR_SCENARIO_CHANGE_HOUSE_MODEL_DATA,
    TR_ACTION_TYPE_HIDE_TRADE_ROUTE,
    TR_PARAMETER_HIDE,
    TR_EMPIRE_HIDE_TRADE_ROUTE,
    TR_EMPIRE_SHOW_TRADE_ROUTE,
    TR_EMPIRE_HIDE_EDGE,
    TR_EMPIRE_SHOW_EDGE,
    TR_ACTION_TYPE_CHANGE_VARIABLE_COLOR,
    TR_CONDITION_TYPE_MONTHS_SINCE_FESTIVAL,
    TR_EMPIRE_VULNERABLE_CITY,
    TR_CONFIG_UI_EDITOR_SHOW_DELETION_WARNINGS,
    TR_CATEGORY_UI_EDITOR,
    TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TITLE,
    TR_EDITOR_SCENARIO_EVENTS_DELETE_EVENTS_CONFIRM_TEXT,
    TR_CONDITION_TYPE_DESIRABILITY_IN_AREA,
    TR_CONDITION_TYPE_POPULATION_IN_AREA,
    TR_PARAMETER_AGE_SCHOOL,
    TR_PARAMETER_AGE_ACADEMY,
    TR_PARAMETER_AGE_WORKING,
    TR_PARAMETER_AGE_RETIRED,
    TR_FIGURE_TYPE_PLEBIAN,
    TR_CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_PLEBIANS,
    TR_EDITOR_MODEL_DATA_DEFAULT,
    TR_ACTION_TYPE_IMMIGRATION_PERCENTAGE,
    TR_PARAMETER_IMMIGRATION,
    ...
    TR_WARNING_ENEMIES_PREVENT_BRIDGE_DESTRUCTION,
    TR_CONFIG_GP_CH_ENEMIES_RETREAT_FAST,
    TR_CONFIG_CATEGORY_MANAGEMENT_MILITARY,
    TR_CHEAT_CHANGED_MONUMENT_RESOURCES,
    TR_ACTION_TYPE_CHANGE_MONUMENT_RESOURCES,
    TR_PARAMETER_TYPE_MONUMENT,
    TR_PARAMETER_MONUMENT_STAGE,
    TR_RESOURCE_ARCHITECTS,
    TR_ACTION_TYPE_RENAME_CITY,
    TR_PARAMETER_TYPE_CITY,
    TR_PARAMETER_NAME,
    TR_CONFIG_UI_AUTO_DELETE_OLD_COMMON_MESSAGES,
    TR_UI_CURRENT_YEAR,
    TR_UI_HIDE_IRRELEVANT_RESOURCES,
    TR_UI_YEAR_AGO,
    TR_UI_YEARS_AGO,
    TR_UI_LAST_YEAR,
    TR_UI_SELECT_TRADE_LEDGER_YEAR,
    TR_UI_TRADE_LEDGER_OPEN,
    TR_UI_TRADE_LEDGER_CLOSED,
    TR_UI_TRADE_LEDGER_BOTH,
    TR_UI_TRADE_LEDGER_TRADES,
    TR_UI_TRADE_LEDGER_BUYS,
    TR_UI_TRADE_LEDGER_SELLS,
    TR_UI_TOOLTIP_CLEAR_SELECTION,
    TR_UI_TOOLTIP_SELECT_RESOURCE_FILTER,
    TR_UI_TOOLTIP_RESET_SORTING,
    TR_UI_TOOLTIP_SELECT_SORTING,
    TR_UI_TOOLTIP_RESET_FILTERS,
    TR_UI_TOOLTIP_SHOW_ALL_ROUTE_TYPES,
    TR_UI_TOOLTIP_SHOW_LAND_ROUTES,
    TR_UI_TOOLTIP_SHOW_SEA_ROUTES,
    TR_UI_TOOLTIP_SHOW_OPEN_AND_CLOSED_ROUTES,
    TR_UI_TOOLTIP_SHOW_OPEN_ROUTES,
    TR_UI_TOOLTIP_SHOW_CLOSED_ROUTES,
    TR_UI_TOOLTIP_SELECT_CITY_RESOURCE_TRADE,
    TR_UI_TOOLTIP_OPEN_TRADE_LEDGER,
    TR_UI_SIDEBAR_TRADE_HISTORY,
    TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP,
    TR_UI_SIDEBAR_TRADE_HISTORY_TOOLTIP_LOST,
    TR_UI_LEDGER_BTN_IMPORTED,
    TR_UI_LEDGER_TT_IMPORTED,
    TR_UI_LEDGER_BTN_PRODUCED,
    TR_UI_LEDGER_TT_PRODUCED,
    TR_UI_LEDGER_BTN_CONSUMED,
    TR_UI_LEDGER_TT_CONSUMED,
    TR_UI_LEDGER_BTN_EXPORTED,
    TR_UI_LEDGER_TT_EXPORTED,
    TR_UI_LEDGER_BTN_STOCK,
    ...
    TR_EMPIRE_ROUTE_COST,
    TR_EMPIRE_RESOURCE_COST,
    TR_EMPIRE_COSTS,
    TR_EMPIRE_NO_RESOURCES_TITLE,
    TR_EMPIRE_NO_RESOURCES_TEXT,
    TR_ACTION_TYPE_CHANGE_ROUTE_RESOURCE_COST,
    TR_ACTION_TYPE_KILL_WALKERS_IN_AREA,
    TR_PARAMETER_TYPE_FIGURE_CATEGORY,
    TR_PARAMETER_FIGURE_CATEGORY_INACTIVE,
    TR_PARAMETER_FIGURE_CATEGORY_CITIZEN,
    TR_PARAMETER_FIGURE_CATEGORY_ARMED,
    TR_PARAMETER_FIGURE_CATEGORY_HOSTILE,
    TR_PARAMETER_FIGURE_CATEGORY_CRIMINAL,
    TR_PARAMETER_FIGURE_CATEGORY_NATIVE,
    TR_PARAMETER_FIGURE_CATEGORY_ANIMAL,
    TR_PARAMETER_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL,
    TR_PARAMETER_FIGURE_CATEGORY_PROJECTILE,
    TR_PARAMETER_FIGURE_CATEGORY_EFFECT,
    TR_PARAMETER_FIGURE_CATEGORY_INDUSTRY,
    TR_PARAMETER_FIGURE_CATEGORY_ENTERTAINMENT,
    TR_PARAMETER_FIGURE_CATEGORY_EDUCATION,
    TR_PARAMETER_FIGURE_CATEGORY_HEALTH,
    TR_PARAMETER_FIGURE_CATEGORY_MULTIPLE,
    TR_PARAMETER_FIGURE_CATEGORY_NONE,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INACTIVE,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CITIZEN,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ARMED,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HOSTILE,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CRIMINAL,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_NATIVE,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ANIMAL,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_PROJECTILE,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EFFECT,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INDUSTRY,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ENTERTAINMENT,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EDUCATION,
    TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HEALTH,
    TR_CONDITION_TYPE_FIGURES_IN_AREA,
    TR_ACTION_TYPE_SEND_CITY_WARNING,
    TR_PARAMETER_MESSAGE,
    TR_PARAMETER_PLAY_FANFARE,
    TR_CONFIG_UI_SCROLL_LEGACY_SCROLLBAR,
