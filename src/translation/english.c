...
static translation_string all_strings[] = {
    ...
    {TR_CITY_MESSAGE_TEXT_KALENDS_GAMES_STARTING, "The Games begin at sunrise on the Kalends of Januarius. Priests conduct animal sacrifices as gladiators gird their arms to die seeking the favor of the divine."},
    ...
    {TR_ACTION_TYPE_TRADE_ADJUST_ROUTE_OPEN_PRICE, "Change trade route open cost (Dn)"},
    ...
    {TR_WINDOW_ADVISOR_EPITHETS_TOOLTIP, "Divine powers granted by Grand Temples"},
    ...
    {TR_ACTION_TYPE_IMMIGRATION_PERCENTAGE, "Adjust migration percentage"},
    {TR_PARAMETER_IMMIGRATION, "Adjust immigration"},
    ...
    {TR_WARNING_ENEMIES_PREVENT_BRIDGE_DESTRUCTION, "You can not destroy bridges while an invasion is ongoing!"},
    {TR_CONFIG_GP_CH_ENEMIES_RETREAT_FAST, "Enemies retreat twice as fast"},
    {TR_CONFIG_CATEGORY_MANAGEMENT_MILITARY, "Military"},
    {TR_CHEAT_CHANGED_MONUMENT_RESOURCES, "Changed needed resources for monument type"},
    ...
    {TR_ACTION_TYPE_CHANGE_ROUTE_RESOURCE_COST, "Change trade route open cost (Resources)"},
    {TR_ACTION_TYPE_KILL_WALKERS_IN_AREA, "Kill walkers in area"},
    {TR_PARAMETER_TYPE_FIGURE_CATEGORY, "Category"},
    {TR_PARAMETER_FIGURE_CATEGORY_INACTIVE, "Inactive"},
    {TR_PARAMETER_FIGURE_CATEGORY_CITIZEN, "Citizen"},
    {TR_PARAMETER_FIGURE_CATEGORY_ARMED, "Armed"},
    {TR_PARAMETER_FIGURE_CATEGORY_HOSTILE, "Hostile"},
    {TR_PARAMETER_FIGURE_CATEGORY_CRIMINAL, "Criminal"},
    {TR_PARAMETER_FIGURE_CATEGORY_NATIVE, "Native"},
    {TR_PARAMETER_FIGURE_CATEGORY_ANIMAL, "Animal"},
    {TR_PARAMETER_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Aggressive animal"},
    {TR_PARAMETER_FIGURE_CATEGORY_PROJECTILE, "Projectile"},
    {TR_PARAMETER_FIGURE_CATEGORY_EFFECT, "Effect"},
    {TR_PARAMETER_FIGURE_CATEGORY_INDUSTRY, "Industry"},
    {TR_PARAMETER_FIGURE_CATEGORY_ENTERTAINMENT, "Entertainment"},
    {TR_PARAMETER_FIGURE_CATEGORY_EDUCATION, "Education"},
    {TR_PARAMETER_FIGURE_CATEGORY_HEALTH, "Health"},
    {TR_PARAMETER_FIGURE_CATEGORY_MULTIPLE, "Multiple"},
    {TR_PARAMETER_FIGURE_CATEGORY_NONE, "None"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_INACTIVE, "Non living figures\n e.g. dust clouds, trade ships and projectiles"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CITIZEN, "All friendly roman people (pets included)"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ARMED, "All people and animals willing to defend your city with their lives"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_HOSTILE, "Everyone who is against you"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_CRIMINAL, "Criminals and rioters"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_NATIVE, "Natives even peaceful ones"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_ANIMAL, "Herd animals"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_AGGRESSIVE_ANIMAL, "Wolves"},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_PROJECTILE, "Projectiles\n e.g. javelins, arrows etc."},
    {TR_PARAMETER_TOOLTIP_FIGURE_CATEGORY_EFFECT, "Cosmetic figures\n e.g. dust clouds, sea gulls or the horses racing in the hippodrome"},
