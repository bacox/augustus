...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_FIXED_WORKERS, "Σταθερό εργατικό δυναμικό - 45% του πληθυσμού των πληβείων"},
    ...
    { TR_CONFIG_DEFAULT_PLAYER_NAME, "Προεπιλεγμένο όνομα παίκτη:" },
    { TR_CONFIG_RANDOMISE_MUSIC, "Τυχαία επιλογή μουσικής πόλης" },
    { TR_CONFIG_NOT_ACCEPTING_MARKETS, "Οι αγορές δεν δέχονται τίποτα όταν χτίζονται" },
    { TR_CONFIG_DRAW_WEATHER, "Ενεργοποίηση δυναμικών καιρικών συνθηκών" },
    { TR_HOTKEY_SHOW_OVERLAY_ENEMY, "Επικάλυψη εχθρού" },
    { TR_BUILDING_MESS_HALL_NO_EMPLOYEES, "Αυτός ο σταθμός ανεφοδιασμού δεν έχει υπαλλήλους. Δεν είναι δυνατή η παραλαβή τροφίμων." },
    { TR_BUILDING_CARAVANSERAI_NO_EMPLOYEES, "Το καραβανσεράι δεν έχει υπαλλήλους. Δεν είναι δυνατή η συλλογή τροφίμων." },
    { TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE, "Το Καραβανσεράι διαθέτει υπαλλήλους και τρόφιμα, αλλά τα αποθέματα είναι πολύ χαμηλά για να προμηθεύσουν όλα τα εμπορικά καραβάνια." },
    { TR_BUILDING_LIGHTHOUSE_NO_TIMBER, "Οι φρουροί του φάρου αγωνίζονται να βρουν την απαραίτητη ξυλεία για να κρατήσουν τη φλόγα αναμμένη. Τα πλοία που πλησιάζουν τις ακτές σας δυσκολεύονται να διακρίνουν τον φως του φάρου που σβήνει." },
    { TR_OVERLAY_EMPLOYMENT, "Απασχόληση" },
    { TR_TOOLTIP_OVERLAY_EMPLOYMENT_FULL, "Αυτό το κτίριο διαθέτει πλήρες προσωπικό." },
    { TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_1, " υπάλληλος απαιτείται σε αυτό το κτίριο" },
    { TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_2, " υπάλληλοι απαιτούνται σε αυτό το κτίριο" },
    { TR_TOOLTIP_OVERLAY_EMPLOYMENT_MOTHBALL, " υπάλληλοι απαιτούνται σε αυτό το κτίριο (εκτός λειτουργίας)" },
    { TR_BUILDING_LARGE_TEMPLE_PHASE_2, "(Πρόσοψη)" },
    { TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "Έμπειροι τεχνίτες προετοιμάζουν την πρόσοψη αυτού του ναού, σκαλίζοντας λαμπερά μαρμάρινα αγάλματα με την εικόνα της θεότητας που θα λατρεύεται εδώ." },
    { TR_BUILDING_ORACLE_DESC, "Αυτό το υπέροχο κτίριο είναι αφιερωμένο σε όλους τους θεούς, από τα πιο ταπεινά τοπικά πνεύματα μέχρι τον ίδιο τον Δία. Ένας τόσο ευσεβής χώρος είναι βέβαιο ότι θα κερδίσει την εύνοια των θεών για την πόλη σας." },
    { TR_BUILDING_ORACLE_PHASE_1, "(Άδυτο)" },
    { TR_BUILDING_ORACLE_PHASE_2, "(Πρόσοψη)" },
    { TR_BUILDING_ORACLE_PHASE_1_TEXT, "Οι χτίστες κατασκευάζουν τους τοίχους και τους πυλώνες του αδύτου, του εσωτερικού χώρου αυτού του μαντείου που θα στεγάσει τις ιερές εικόνες." },
    { TR_BUILDING_ORACLE_PHASE_2_TEXT, "Έμπειροι τεχνίτες προετοιμάζουν την πρόσοψη αυτού του μαντείου, σκαλίζοντας λαμπερά μαρμάρινα αγάλματα με τις εικόνες των πολλών θεών που θα λατρεύονται εδώ." },
    { TR_BUILDING_NYMPHAEUM_PHASE_1, "(Άδυτο)" },
    { TR_BUILDING_NYMPHAEUM_PHASE_2, "(Πρόσοψη)" },
    { TR_BUILDING_NYMPHAEUM_PHASE_1_TEXT, "Οι χτίστες κατασκευάζουν τους τοίχους και τους πυλώνες του αδύτου, του εσωτερικού χώρου αυτού του ναού που θα στεγάσει τις εικόνες των νυμφών και των ιερών νερών τους." },
    { TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "Έμπειροι τεχνίτες προετοιμάζουν την πρόσοψη αυτού του ναού, σκαλίζοντας λαμπερά μαρμάρινα αγάλματα με τις εικόνες των νυμφών του νερού και στολίζοντας τους τοίχους με κοχύλια και μωσαϊκά του νερού." },
    { TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "(Κρύπτη)" },
    { TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2, "(Πρόσοψη)" },
    { TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "Οι χτίστες τοποθετούν σειρές από λαξευμένες με ακρίβεια πέτρες για να σχηματίσουν τον κεντρικό θόλο αυτού του μαυσωλείου." },
    { TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "Έμπειροι τεχνίτες προετοιμάζουν την πρόσοψη αυτού του μαυσωλείου, σκαλίζοντας λαμπερά μαρμάρινα αγάλματα για να τιμήσουν τη μνήμη όσων θα αναπαυθούν εδώ." },
    { TR_BUILDING_BOTH_MAUSOLEUM_DESC, "Αυτό το μαυσωλείο ευχαριστεί όλους τους θεούς, αν και δεν είναι επιθυμητό για τα κοντινά σπίτια. Τέτοιες ταφικές θέσεις βελτιώνουν τις συνθήκες υγιεινής στην πόλη, αυξάνοντας τη γενική υγεία των πολιτών σας." },
    { TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION, "Άδειες περιπατητών" },
    { TR_OVERLAY_LOGISTICS, "Εφοδιαστική" },
    { TR_OVERLAY_HEALTH, "Γενική" },
    { TR_ADVISOR_HEALTH_RATING, "Αξιολόγηση:" },
    { TR_ADVISOR_HEALTH_SURVEILLANCE, "Παρακολούθηση ασθενειών:" },
    { TR_TOOLTIP_OVERLAY_HEALTH_NONE, "Κανένας δεν ζει εδώ ακόμα" },
    { TR_TOOLTIP_OVERLAY_HEALTH_0, "Η υγεία σε αυτό το σπίτι είναι αποτρόπαια" },
    { TR_TOOLTIP_OVERLAY_HEALTH_1, "Η υγεία σε αυτό το σπίτι είναι χάλια." },
    { TR_TOOLTIP_OVERLAY_HEALTH_2, "Η υγεία σε αυτό το σπίτι είναι κακή." },
    { TR_TOOLTIP_OVERLAY_HEALTH_3, "Η υγεία σε αυτό το σπίτι είναι φτωχή." },
    { TR_TOOLTIP_OVERLAY_HEALTH_4, "Η υγεία σε αυτό το σπίτι είναι κάτω του μετρίου." },
    { TR_TOOLTIP_OVERLAY_HEALTH_5, "Η υγεία σε αυτό το σπίτι είναι μέτρια." },
    { TR_TOOLTIP_OVERLAY_HEALTH_6, "Η υγεία σε αυτό το σπίτι είναι καλή." },
    { TR_TOOLTIP_OVERLAY_HEALTH_7, "Η υγεία σε αυτό το σπίτι είναι πολύ καλή." },
    { TR_TOOLTIP_OVERLAY_HEALTH_8, "Η υγεία σε αυτό το σπίτι είναι εξαιρετική." },
    { TR_TOOLTIP_OVERLAY_HEALTH_9, "Η υγεία σε αυτό το σπίτι είναι σχεδόν τέλεια." },
    { TR_TOOLTIP_OVERLAY_HEALTH_10, "Η υγεία σε αυτό το σπίτι είναι τέλεια" },
    { TR_HOTKEY_SHOW_OVERLAY_LOGISTICS, "Επικάλυψη διανομής" },
    { TR_HOTKEY_SHOW_OVERLAY_HEALTH, "Επικάλυψη υγείας" },
    { TR_HOTKEY_SHOW_OVERLAY_EMPLOYMENT, "Επικάλυψη απασχόλησης" },
    { TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TITLE, "Το αρχείο δεν υπάρχει" },
    { TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TEXT, "Το επιλεγμένο αρχείο δεν υπάρχει.\nΕπιλέξτε ένα άλλο αρχείο." },
    { TR_BUILDING_CITY_MINT_PHASE_2, "(Νομισματοκοπείο)" },
    { TR_BUILDING_CITY_MINT_PHASE_2_TEXT, "Οι τεχνίτες δίνουν τις τελευταίες πινελιές στο Νομισματοκοπείο, το μέρος όπου θα κοπούν τα νομίσματα, δημιουργώντας κτίρια για την αποθήκευση των άκοπων δηναρίων και καταλύματα για τους νομισματοκόπους." },
    { TR_EDITOR_REPEAT, "Επανάληψη:" },
    { TR_EDITOR_DO_NOT_REPEAT, "Όχι επανάληψη" },
    { TR_EDITOR_REPEAT_FOREVER, "Επανάληψη για πάντα" },
    { TR_EDITOR_REPEAT_ONCE, "Επανάληψη μία φορά" },
    { TR_EDITOR_REPEAT_TWICE, "Επανάληψη δύο φορές" },
    { TR_EDITOR_REPEAT_TEXT, "Επανάληψη" },
    { TR_EDITOR_REPEAT_TIMES, " φορές" },
    { TR_EDITOR_REPEAT_TIMES2, "Φορές:" },
    { TR_EDITOR_REPEAT_FREQUENCY, "Συχνότητα επανάληψης:" },
    { TR_EDITOR_REPEAT_FREQUENCY2, "Συχνότητα επανάληψης" },
    { TR_EDITOR_REPEAT_FREQUENCY_YEARS, "χρόνια" },
    { TR_EDITOR_REPEAT_FREQUENCY_YEARS2, "χρόνια:" },
    { TR_EDITOR_REPEAT_FREQUENCY_MONTHS, "μήνες" },
    { TR_EDITOR_SCENARIO_EVENTS_SET_TO_GROUP, "Ορίστε την επιλογή σε ομάδα..." },
    { TR_EDITOR_SCENARIO_EVENTS_NO_GROUP, "Καμία ομάδα" },
    { TR_EDITOR_SCENARIO_EVENTS_GROUP, "Ομάδα " },
    { TR_EDITOR_SCENARIO_EVENTS_NEW_GROUP, "Νέα ομάδα" },
    { TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED, "Διαγραφή επιλεγμένων" },
    { TR_EDITOR_SCENARIO_EVENTS_GROUPS_EXPLANATION_TOOLTIP, "Εάν πληρούται οποιαδήποτε συνθήκη σε μια ομάδα, η ομάδα θεωρείται ότι πληροί τις προϋποθέσεις. Για να ενεργοποιηθεί το συμβάν, πρέπει να πληρούνται όλες οι ομάδες, καθώς και όλες οι συνθήκες που δεν ανήκουν σε ομάδα." },
    { TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TITLE, "Διαγραφή επιλεγμένων;" },
    { TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TEXT, "Είστε σίγουροι ότι θέλετε να διαγράψετε τα επιλεγμένα στοιχεία;\n\nΗ ενέργεια είναι μη αναστρέψιμη." },
    { TR_EDITOR_SCENARIO_EVENT_NAME, "Όνομα: " },
    { TR_EDITOR_SCENARIO_NO_CONDITIONS, "Χωρίς όρους" },
    { TR_EDITOR_SCENARIO_NO_ACTIONS, "Καμία ενέργεια" },
    { TR_EDITOR_SCENARIO_SELECT_CONDITION, "Επιλέξτε συνθήκη" },
    { TR_EDITOR_SCENARIO_SELECT_ACTION, "Επιλέξτε ενέργεια" },
    { TR_EDITOR_SCENARIO_SELECT_VICTORY, "Επιλέξτε μήνυμα νίκης" },
    { TR_EDITOR_SCENARIO_DESELECT_VICTORY, "Κατάργηση μηνύματος νίκης" },
    { TR_EDITOR_CUSTOM_VARIABLES_COUNT, "Σύνολο μεταβλητών:" },
    { TR_EDITOR_CUSTOM_VARIABLES_ID, "Αναγνωριστικό" },
    { TR_EDITOR_CUSTOM_VARIABLES_NAME, "Όνομα" },
    { TR_EDITOR_CUSTOM_VARIABLES_VALUE, "Αρχική τιμή" },
    { TR_EDITOR_CUSTOM_VARIABLES_NEW, "Νέα προσαρμοσμένη μεταβλητή" },
    { TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TITLE, "Δεν είναι δυνατή η ρύθμιση του ονόματος της προσαρμοσμένης μεταβλητής" },
    { TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TEXT, "Το όνομα είναι κενό ή χρησιμοποιείται ήδη από άλλη προσαρμοσμένη μεταβλητή.\n\nΠαρακαλώ μετονομάστε τη μεταβλητή." },
    { TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TITLE, "Δεν είναι δυνατή η διαγραφή προσαρμοσμένης/ων μεταβλητής/ών" },
    { TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TEXT, "Η/οι προσαρμοσμένη/ες μεταβλητή/ές χρησιμοποιείται/χρησιμοποιούνται από τουλάχιστον ένα συμβάν.\n\nΑφαιρέστε την προσαρμοσμένη μεταβλητή από το συμβάν για να μπορέσετε να τη διαγράψετε." },
    { TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_EVENT_ID, "Πρώτο αναγνωριστικό συμβάντος όπου χρησιμοποιείται η μεταβλητή: " },
    { TR_EDITOR_CUSTOM_VARIABLES_IN_USE, "Προσαρμοσμένες μεταβλητές σε χρήση: " },
    { TR_EDITOR_RETURN_TO_CITY, "Επιστροφή στην πόλη" },
    { TR_PARAMETER_TYPE_GOD, "Θεός" },
    { TR_PARAMETER_TYPE_CLIMATE, "Κλίμα" },
    { TR_PARAMETER_TYPE_REQUEST, "Αίτημα" },
    { TR_ACTION_TYPE_CAUSE_BLESSING, "Προκαλέστε μια ευλογία" },
    { TR_ACTION_TYPE_CAUSE_MINOR_CURSE, "Προκαλέστε μια μικρή κατάρα" },
    { TR_ACTION_TYPE_CAUSE_MAJOR_CURSE, "Προκαλέστε μια μεγάλη κατάρα" },
    { TR_ACTION_TYPE_CHANGE_CLIMATE, "Αλλαγή κλίματος" },
    { TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH, "Ομιλία" },
    { TR_PARAMETER_VALUE_MEDIA_TYPE_BACKGROUND_IMAGE, "Εικόνα φόντου" },
    { TR_PARAMETER_VALUE_GOD_CERES, "Δήμητρα" },
    { TR_PARAMETER_VALUE_GOD_MARS, "Άρης" },
    { TR_PARAMETER_VALUE_GOD_MERCURY, "Ερμής" },
    { TR_PARAMETER_VALUE_GOD_NEPTUNE, "Ποσειδώνας" },
    { TR_PARAMETER_VALUE_GOD_VENUS, "Αφροδίτη" },
    { TR_PARAMETER_VALUE_CLIMATE_CENTRAL, "Κεντρικό" },
    { TR_PARAMETER_VALUE_CLIMATE_NORTHERN, "Βόρειο" },
    { TR_PARAMETER_VALUE_CLIMATE_DESERT, "Έρημος" },
    { TR_REPLAY_MAP_NOT_FOUND_TITLE, "Δεν είναι δυνατή η αναπαραγωγή του χάρτη" },
    { TR_REPLAY_MAP_NOT_FOUND_MESSAGE, "Το αρχικό αρχείο χάρτη για αυτό το αποθηκευμένο παιχνίδι δεν βρέθηκε.\nΧρειάζεστε το ακόλουθο αρχείο με επέκταση .map ή .mapx:" },
    { TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_ACCEPT_ALL, "Αποδοχή όλων των περιπατητών" },
    { TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_REJECT_ALL, "Απόρριψη όλων των περιπατητών" },
    { TR_TOOLTIP_BUTTON_STORAGE_ORDER_ACCEPT_ALL, "Αποδοχή όλων των εμπορευμάτων" },
    { TR_TOOLTIP_BUTTON_STORAGE_ORDER_REJECT_ALL, "Απόρριψη όλων των εμπορευμάτων" },
    { TR_FIGURE_TYPE_BEGGAR, "Ζητιάνος" },
    { TR_BUILDING_ARMOURY, "Οπλοστάσιο" },
    { TR_BUILDING_ARMOURY_NO_EMPLOYEES, "Χωρίς πρόσβαση σε εργαζόμενους, το οπλοστάσιο δεν μπορεί να παραδώσει όπλα στους στρατιώτες μας. Είθε ο Άρης να μας προστατεύσει, γιατί οι άοπλοι στρατιώτες σίγουρα δεν θα το κάνουν!" },
    { TR_BUILDING_ARMOURY_SOME_EMPLOYEES, "Δεδομένου ότι το οπλοστάσιο είναι μόνο μερικώς στελεχωμένο, ο πλήρης εξοπλισμός των λεγεώνων θα απαιτήσει σημαντικό χρόνο. Ας ελπίσουμε ότι και οι εχθροί μας θα πάρουν το χρόνο τους!" },
    ...
    { TR_BUILDING_ARMOURY_DESC, "Το οπλοστάσιο εξασφαλίζει την ταχεία και αποτελεσματική προμήθεια όπλων στους στρατιώτες μας. Αυτοί οι βάρβαροι δεν μπορούν να ανταγωνιστούν τη ρωμαϊκή εφοδιαστική!" },
    { TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD, "Αυτή η ταβέρνα διασκεδάζει τους πολίτες σας όσο το κρασί συνεχίζει να ρέει. Μια προμήθεια κρέατος ή ψαριού θα αύξανε την ελκυστικότητά της. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, παρέχοντας περισσότερο χώρο για τους πελάτες." },
    { TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD, "Αυτή η ταβέρνα διαθέτει άφθονο κρασί, και η μυρωδιά του ψημένου κρέατος προσελκύει ένα ζωντανό πλήθος για τζόγο, μουσική και διασκέδαση. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, παρέχοντας περισσότερο χώρο για τους πελάτες." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "Αυτό το αμφιθέατρο προσφέρει στην κοινότητά του τόσο συναρπαστικές μονομαχίες όσο και θεατρικές παραστάσεις από τοπικούς ηθοποιούς. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, προσφέροντας περισσότερες θέσεις για να παρακολουθήσουν τις παραστάσεις." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS, "Αυτό το αμφιθέατρο φιλοξενεί θεατρικές παραστάσεις με τοπικούς ηθοποιούς. Θα άρεσε περισσότερο στο κοινό αν είχε μονομάχους που θα έδιναν ζωντανές μάχες. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, αλλά οι μονομάχοι θα εξασφάλιζαν ότι οι επιπλέον θέσεις θα παρέμεναν γεμάτες." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "Αυτό το αμφιθέατρο φιλοξενεί μονομαχίες για την ψυχαγωγία της τοπικής κοινότητας, αλλά δεν διαθέτει θεατρικές παραστάσεις μεταξύ των αγώνων. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, αλλά οι ηθοποιοί θα εξασφαλίσουν ότι οι επιπλέον θέσεις θα παραμείνουν γεμάτες." },
    ...
    { TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "Αυτή η αρένα φιλοξενεί μονομαχίες και κυνήγια ζώων, για τη διασκέδαση του πλήθους. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, προσφέροντας περισσότερες θέσεις για να παρακολουθούν τις παραστάσεις." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_GLADIATORS, "Αυτή η αρένα είναι γεμάτη από πεινασμένα θηρία που αναζητούν τη λεία τους, αλλά η έλλειψη εκπαιδευμένων μονομάχων κάνει τις παραστάσεις σύντομες. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, αλλά οι μονομάχοι θα εξασφάλιζαν ότι οι επιπλέον θέσεις θα παρέμεναν γεμάτες." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_LIONS, "Αυτή η αρένα φιλοξενεί τακτικά μονομαχίες για να διασκεδάζει τον όχλο, αλλά οι παραστάσεις με λιοντάρια θα ανέβαζαν το επίπεδο του θεάματος. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, αλλά τα λιοντάρια θα εξασφάλιζαν ότι οι επιπλέον θέσεις θα παρέμεναν γεμάτες." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_SHOWS, "Αυτή η αρένα δεν φιλοξενεί ούτε λιοντάρια ούτε μονομάχους και προσφέρει ελάχιστη διασκέδαση. Η τοπική ανάπτυξη επέτρεψε στους πολίτες σας να επεκτείνουν το κτίριο, αλλά χωρίς παραστάσεις, οι επιπλέον θέσεις παραμένουν άδειες." },
    { TR_CHEAT_CASTED_CURSE, "Ρίξε μια κατάρα" },
    { TR_CHEAT_BUILDINGS_INVINCIBLE, "Τα κτίρια που έχουν κατασκευαστεί δεν καταρρέουν" },
    { TR_CHEAT_CLIMATE_CHANGE, "Αλλαγή κλίματος σε ισχύ" },
    ...
    { TR_WINDOW_ORIGINAL_CAMPAIGN_NAME, "Πρωτότυπη εκστρατεία" },
    { TR_WINDOW_ORIGINAL_CAMPAIGN_DESC, "Η πρωτότυπη εκστρατεία του Caesar 3 από το 1998, σε όλη της την αρχαία δόξα." },
    { TR_WINDOW_INVALID_CAMPAIGN_TITLE, "Μη έγκυρο αρχείο εκστρατείας" },
    { TR_WINDOW_INVALID_CAMPAIGN_TEXT, "Το αρχείο εκστρατείας που παρέχεται δεν είναι έγκυρο.\nΓια περισσότερες λεπτομέρειες, ελέγξτε το αρχείο augustus-log.txt στον κατάλογο Augustus." },
    { TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TITLE, "Δεν είναι δυνατή η έναρξη της αποστολής" },
    { TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TEXT, "Η ζητούμενη αποστολή δεν μπόρεσε να ανοίξει.\nΕλέγξτε το αρχείο augustus-log.txt στον κατάλογο Augustus για λεπτομέρειες." },
    { TR_WINDOW_CAMPAIGN_BUTTON_BEGIN_CAMPAIGN, "Ξεκινήστε την εκστρατεία" },
    { TR_WINDOW_CAMPAIGN_BUTTON_MISSION_LIST, "Επιλογή σεναρίου" },
    { TR_WINDOW_CAMPAIGN_CURRENT_MISSION, "Τρέχουσα αποστολή:" },
    { TR_WINDOW_CAMPAIGN_FINISHED, "Η εκστρατεία ολοκληρώθηκε" },
    { TR_WINDOW_MISSION_LIST_CAMPAIGN_NOT_FINISHED, "Η εκστρατεία δεν ολοκληρώθηκε" },
    { TR_WINDOW_MISSION_LIST_BUTTON_BEGIN_SCENARIO, "Έναρξη σεναρίου" },
    { TR_WINDOW_MISSION_LIST_BUTTON_SCENARIO_SELECTION, "Επιλογή σεναρίου" },
    { TR_WINDOW_MISSION_LIST_SCENARIOS, "σενάρια" },
    { TR_ORIGINAL_CAMPAIGN_FIRST_MISSION, "Εκπαιδευτικό πρόγραμμα 1" },
    { TR_ORIGINAL_CAMPAIGN_SECOND_MISSION, "Βρυνδίζιο: Εκπαιδευτικό πρόγραμμα 2" },
    { TR_EDITOR_CAESAR_SALARY, "Μισθός του Καίσαρα" },
    { TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "Το Καραβανσεράι έχει πλέον ολοκληρωθεί και σίγουρα θα εμφανιστούν νέες εμπορικές ευκαιρίες. Καραβάνια από όλο τον κόσμο έχουν ήδη ανακοινώσει ότι είναι πρόθυμα να έρθουν και να κάνουν εμπόριο με την πόλη σας." },
    { TR_WINDOW_BARRACKS_PRIORITY, "Προτεραιότητα πρόσληψης:" },
    { TR_WINDOW_BARRACKS_FORTS, "Φρούρια" },
    { TR_WINDOW_BARRACKS_TOWERS, "Πύργοι" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_FORT, "Προτεραιότητα στην εκπαίδευση Λεγεωνάριων" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_JAVELIN, "Προτεραιότητα στην εκπαίδευση ακοντιστών" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_MOUNTED, "Προτεραιότητα στην εκπαίδευση ιππέων" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_AUXINF, "Προτεραιότητα στην εκπαίδευση των ξίφων" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_AUXARCH, "Προτεραιότητα στην εκπαίδευση των τόξων" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Προτεραιότητα στην εκπαίδευση των φρουρών των πύργων" },
    { TR_TOOLTIP_BARRACKS_PRIORITY_WATCHTOWER, "Προτεραιότητα στην εκπαίδευση των φυλάκων του πύργου" },
    { TR_TOOLTIP_BUTTON_REJECT_DELIVERY, "Μην επιτρέπετε στα οπλοστάσια να παραδίδουν όπλα εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_DELIVERY, "Να επιτρέπεται η παράδοση όπλων από τα οπλοστάσια εδώ" },
    { TR_CONFIG_SHOW_DESIRABILITY_RANGE, "Δείξτε την ελκυστικότητα κατά την κατασκευή θρησκευτικών ή στρατιωτικών κτιρίων" },
    { TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL, "Δείξτε την ελκυστικότητα κατά την κατασκευή οποιωνδήποτε κατασκευών" },
    { TR_BUILDING_FORT_LEGIONARIES, "Λεγεωνάριοι" },
    { TR_BUILDING_FORT_JAVELIN, "Βοηθητικά - Ακόντια" },
    { TR_BUILDING_FORT_MOUNTED, "Βοηθητικά - Ιππείς" },
    { TR_BUILDING_FORT_AUXILIA_INFANTRY, "Βοηθητικά - Ξίφη" },
    { TR_BUILDING_FORT_ARCHERS, "Βοηθητικά - Τόξα" },
    { TR_WINDOW_ADVISOR_LEGIONARIES, "Λεγεωνάριοι" },
    { TR_WINDOW_ADVISOR_JAVELIN, "Ακόντια" },
    { TR_WINDOW_ADVISOR_MOUNTED, "Ιππείς" },
    { TR_WINDOW_ADVISOR_MILITARY_INFANTRY, "Ξίφη" },
    { TR_WINDOW_ADVISOR_MILITARY_ARCHER, "Τόξα" },
    { TR_TOOLTIP_BUTTON_REJECT_MARKET_LADIES, "Μην επιτρέπετε στις αγορές να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_TRADE_CARAVAN, "Μην επιτρέπετε στα εμπορικά καραβάνια να φεύγουν από εδώ." },
    { TR_TOOLTIP_BUTTON_REJECT_TRADE_SHIPS, "Μην επιτρέπετε στα εμπορικά πλοία που έχουν αγκυροβολήσει να έρθουν από εδώ." },
    { TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER, "Μην επιτρέψετε το εφοδιαστικό σταθμό να έρθει από εδώ." },
    { TR_TOOLTIP_BUTTON_ACCEPT_BARKEEP, "Επιτρέψτε στις ταβέρνες να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_BARKEEP, "Μην επιτρέπετε στις ταβέρνες να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "Επιτρέψτε στο Καραβανσαράι να έρθει από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "Μην αφήσετε το Καραβανσαράι να έρθει από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_LIGHTHOUSE, "Επιτρέψτε στον Φάρο να έρθει από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_LIGHTHOUSE, "Μην επιτρέψετε στον Φάρο να έρθει από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_ARMOURY, "Επιτρέψτε στα οπλοστάσια να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_ARMOURY, "Μην επιτρέψετε στα οπλοστάσια να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP, "Επιτρέψτε στα στρατόπεδα εργασίας να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "Μην επιτρέπετε τα κέντρα εργασίας να έρθουν από εδώ" },
    { TR_WARNING_NO_ARMOURY, "Κατασκευάστε ένα οπλοστάσιο για να παραδώσετε όπλα στα στρατόπεδα" },
    { TR_CONFIG_USER_PATH_DEFAULT, "Προεπιλογή (διαδρομή εγκατάστασης Caesar III, χωρίς υποκαταλόγους)" },
    { TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES, "Διαδρομή εγκατάστασης του Caesar III, χρησιμοποιώντας υποκαταλόγους" },
    { TR_CONFIG_USER_PATH_RECOMMENDED, "Συνιστάται (" },
    { TR_CONFIG_USER_PATH_CUSTOM, "Ορίστε προσαρμοσμένο κατάλογο..." },
    { TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "Οι προσαρμοσμένοι κατάλογοι χρηστών δεν έχουν ρυθμιστεί" },
    { TR_USER_DIRECTORIES_CANCELLED_TITLE, "Η επιλογή καταλόγου ακυρώθηκε" },
    { TR_USER_DIRECTORIES_CANCELLED_TEXT, "Αποφασίσατε να μην ορίσετε κατάλογο χρήστη. Θα χρησιμοποιηθεί ο κατάλογος εγκατάστασης C3.\nΜπορείτε να αλλάξετε τις ρυθμίσεις σας αργότερα στο παράθυρο διαμόρφωσης." },
    { TR_USER_DIRECTORIES_NOT_WRITEABLE_TITLE, "Ο κατάλογος χρήστη δεν είναι εγγράψιμος" },
    ...
    { TR_FIGURE_TYPE_ARMORY_CARTPUSHER, "Διανομέας οπλοστασίου" },
    { TR_TOOLTIP_BUTTON_CAN_GO_TO_ADVISORS, "Εμφάνιση του αρμόδιου συμβούλου για αυτό το κτίριο." },
    { TR_FIGURE_ENEMY_CATAPULT, "Καταπέλτης" },
    { TR_EDITOR_BETWEEN, "Μεταξύ" },
    { TR_EDITOR_AND, "και" },
    { TR_EDITOR_UNITS, "μονάδες" },
    { TR_EDITOR_REQUEST, "αίτηση" },
    { TR_EDITOR_REQUESTS, "αιτήσεις" },
    { TR_EDITOR_REQUEST_DATE, "Ημερομηνία αίτησης:" },
    { TR_EDITOR_REQUEST_RESOURCE, "Πόρος:" },
    { TR_EDITOR_REQUEST_AMOUNT, "Ποσό:" },
    { TR_EDITOR_REQUEST_DEADLINE, "Προθεσμία:" },
    { TR_EDITOR_REQUEST_FAVOR_GAINED, "Κέρδος εύνοιας:" },
    { TR_EDITOR_NEW_REQUEST, "Νέα αίτηση" },
    { TR_EDITOR_INVASION, "εισβολή" },
    { TR_EDITOR_INVASIONS, "εισβολές" },
    { TR_EDITOR_NEW_INVASION, "Νέα εισβολή" },
    { TR_EDITOR_INVASION_DATE, "Ημερομηνία εισβολής:" },
    { TR_EDITOR_INVASION_SIZE, "Μέγεθος εισβολής:" },
    { TR_EDITOR_INVASION_ENEMY_TYPE, "Τύπος εχθρού:" },
    { TR_EDITOR_INVASION_FROM, "Από:" },
    { TR_EDITOR_INVASION_ATTACK_PRIORITY, "Προτεραιότητα επίθεσης:" },
    { TR_EDITOR_NEW_DEMAND_CHANGE, "Νέα μεταβολή ζήτησης" },
    { TR_EDITOR_NO_DEMAND_CHANGES, "Καμία μεταβολή ζήτησης" },
    { TR_EDITOR_NO_ROUTES, "(Χωρίς εμπορικές διαδρομές)" },
    { TR_EDITOR_UNKNOWN_ROUTE, "(Άγνωστη διαδρομή)" },
    { TR_EDITOR_SET_A_ROUTE, "(Ορίστε μια διαδρομή)" },
    { TR_EDITOR_NO_PRICE_CHANGES, "Καμία αλλαγή στις τιμές" },
    { TR_EDITOR_NEW_PRICE_CHANGE, "Νέα αλλαγή τιμής" },
    { TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES, "Διαγραφή κοινών μηνυμάτων" },
    { TR_EDITOR_FORM_ERRORS_FOUND, "Σφάλματα που εντοπίστηκαν στη φόρμα" },
    { TR_EDITOR_FORM_HAS_FOLLOWING_ERRORS, "Η φόρμα περιέχει τα ακόλουθα σφάλματα:" },
    { TR_EDITOR_EDIT_REQUEST_NO_RESOURCE, "Δεν έχουν οριστεί πόροι" },
    { TR_EDITOR_EDIT_REQUEST_NO_AMOUNT, "Δεν έχει οριστεί ποσό" },
    { TR_EDITOR_EDIT_REQUEST_SET_DEADLINE, "Η προθεσμία πρέπει να είναι τουλάχιστον ένα έτος." },
    { TR_EDITOR_EDIT_INVASION_NO_TYPE, "Δεν έχει οριστεί τύπος εχθρού" },
    { TR_EDITOR_EDIT_INVASION_NO_SOLDIERS, "Κανένας στρατιώτης δεν είναι έτοιμος για εισβολή" },
    { TR_EDITOR_EDIT_INVASION_SET_YEAR, "Η εισβολή δεν μπορεί να ξεκινήσει τον πρώτο χρόνο." },
    { TR_EDITOR_EDIT_DEMAND_CHANGE_NO_YEAR, "Η αλλαγή δεν μπορεί να πραγματοποιηθεί κατά το πρώτο έτος." },
    { TR_EDITOR_EDIT_DEMAND_CHANGE_INVALID_ROUTE_SET, "Μη έγκυρη διαδρομή" },
    { TR_EDITOR_ALLOWED_BUILDINGS_ALLOWED, "Επιτρέπεται" },
    { TR_EDITOR_ALLOWED_BUILDINGS_NOT_ALLOWED, "Δεν επιτρέπεται" },
    { TR_SELECT_NONE, "Select None" },
    { TR_SELECT_ALL, "Select All" },
    { TR_SELECTED, "Selected" },
    { TR_WINDOW_MESSAGE_LIST_SELECTED_ALL, "All messages" },
    { TR_WINDOW_MESSAGE_LIST_SELECTED_COMMON, "Κοινά μηνύματα" },
    { TR_WINDOW_MESSAGE_LIST_SELECTED_CUSTOM, "Προσαρμοσμένα μηνύματα" },
    { TR_BUILDING_LATRINES, "Βεσπασιανές" },
    { TR_BUILDING_LATRINES_DESC_1, "Ένα άνετο μέρος που εκτιμάται από τον πληθυσμό για να συζητήσει τα νέα της ημέρας ή τις δουλειές του." },
    { TR_BUILDING_LATRINES_DESC_2, "Τα αποχωρητήρια χρησιμοποιούνται από πολίτες που έχουν πρόσβαση μόνο σε πηγάδι και συμβάλλουν στη μικρή βελτίωση των συνθηκών στέγασης και υγείας. Τα σπίτια που βρίσκονται σε απόσταση από πηγή νερού δεν χρησιμοποιούν τα δημόσια αποχωρητήρια." },
    { TR_BUILDING_LATRINES_MISSING_EVOLVE, "Αυτό το σπίτι δεν μπορεί να εξελιχθεί, καθώς δεν έχει πρόσβαση σε αποχωρητήριο ή σε καθαρό νερό από κρύνη." },
    { TR_BUILDING_LATRINES_MISSING_DEVOLVE, "Αυτό το σπίτι θα καταρρεύσει σύντομα, καθώς δεν έχει πρόσβαση σε αποχωρητήριο ή καθαρό νερό από κρύνη." },
    { TR_BUILDING_LATRINES_NO_WORKERS, "Χωρίς υπαλλήλους για τη συντήρηση των Βεσπασιανών, οι πολίτες αποφεύγουν να έρχονται εκεί για να χαλαρώσουν." },
    { TR_BUILDING_LATRINES_UNNECESSARY, "Αυτά τα αποχωρητήρια δεν έχουν κανένα σκοπό εδώ, καθώς δεν υπάρχουν σπίτια στην περιοχή που να τα χρειάζονται." },
    { TR_BUILDING_LATRINES_NO_HOUSES, "Αυτά τα αποχωρητήρια είναι περιττά προς το παρόν, καθώς δεν υπάρχουν σπίτια εντός της περιοχής που να τα χρειάζονται." },
    { TR_CONFIG_DRAW_ASCLEPIUS, "Σχεδιάστε τη ράβδο του Ασκληπιού για το μενού υγείας" },
    { TR_EDITOR_SCENARIO_BUILDING_NATIVE_HUT_ALT, "Εναλλακτική ιθαγενής καλύβα" },
    { TR_BUILDING_NATIVE_HUT_ALT, "Εναλλακτική ιθαγενής καλύβα" },
    { TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, "Οι αποθήκες και οι σιταποθήκες μπορούν να χτιστούν πάνω από οποιονδήποτε δρόμο." },
    { TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING, "Επισήμανση επιλεγμένου κτιρίου" },
    { TR_CHEAT_UNLOCK_LEGIONS, "Επιτρεπόμενες λεγεώνες: 20" },
    { TR_BUILDING_FORT_STANDARD_ELEPHANTS, "\"Οι Ελέφαντες\"" },
    { TR_BUILDING_FORT_STANDARD_THUNDER_BOLTS, "\"Οι Κεραυνοί\"" },
    { TR_BUILDING_FORT_STANDARD_BULLS, "\"Οι Ταύροι\"" },
    { TR_BUILDING_FORT_STANDARD_CENTAURS, "\"Οι Κένταυροι\"" },
    { TR_BUILDING_FORT_STANDARD_OCTOPI, "\"Τα Χταπόδια\"" },
    { TR_BUILDING_FORT_STANDARD_BEARS, "\"Οι Αρκούδες\"" },
    { TR_BUILDING_FORT_STANDARD_SCORPIONS, "\"Οι Σκορπιοί\"" },
    { TR_BUILDING_FORT_STANDARD_CAMELS, "\"Οι Καμήλες\\" },
    { TR_BUILDING_FORT_STANDARD_DOLPHINS, "\"Τα Δελφίνια\"" },
    { TR_BUILDING_FORT_STANDARD_SEA_GOATS, "\"Οι αιγόκεροι\"" },
    { TR_WINDOW_BUILDING_DISTRIBUTION_MAINTAINING, "Διατήρηση" },
    { TR_CONFIG_MAX_AUTOSAVE_SLOTS, "Μέγιστος αριθμός θέσεων αυτόματης αποθήκευσης ανά έτος:" },
    { TR_TOOLTIP_PERSONAL_SAVINGS, "Οι προσωπικές σας αποταμιεύσεις!" },
    { TR_EDITOR_SCENARIO_BUILDING_NATIVE_DECORATION, "Διακόσμηση" },
    { TR_EDITOR_SCENARIO_BUILDING_NATIVE_MONUMENT, "Μνημείο" },
    { TR_EDITOR_SCENARIO_BUILDING_NATIVE_WATCHTOWER, "Παρατηρητήριο" },
    { TR_BUILDING_NATIVE_DECORATION, "Ντόπια διακόσμηση" },
    { TR_BUILDING_NATIVE_MONUMENT, "Μνημείο των ιθαγενών" },
    { TR_BUILDING_NATIVE_WATCHTOWER, "Ιθαγενής Παρατηρητήριο" },
    { TR_BUILDING_NATIVE_DECORATION_DESC, "Αυτό το διακοσμητικό κτίριο, προϊόν τοπικών τεχνιτών, απολαμβάνει μεγάλη εκτίμηση τόσο από τους ντόπιους όσο και από τους Ρωμαίους. Παρά την έλλειψη φινέτσας, πολλοί πολίτες το θεωρούν προκλητικό για τη σκέψη." },
    { TR_BUILDING_NATIVE_MONUMENT_DESC, "Αυτό το μεγαλοπρεπές κτίσμα στέκεται σε άγρυπνη φύλαξη αυτών των εδαφών από αμνημονεύτων χρόνων. Κάποιοι ισχυρίζονται ότι αποδεικνύει ότι, με ευρηματικότητα και σκληρή δουλειά, οι ντόπιοι μπορούν να επιτύχουν σπουδαία πράγματα, παρά τις περιορισμένες γνώσεις τους στον τομέα της μηχανικής. Άλλοι, πιο σκεπτικιστές, υποθέτουν ότι είναι, ίσως, ένα θαύμα των θεών ή ένα κατάλοιπο ενός αρχαίου, εξαιρετικά προηγμένου πολιτισμού." },
    { TR_BUILDING_NATIVE_WATCHTOWER_DESC, "Χρησιμοποιώντας αυτές τις κατασκευές, οι ντόπιοι παρακολουθούν κάθε κίνηση στην πόλη σας, πάντα έτοιμοι να εκμεταλλευτούν τα σημάδια αδυναμίας. Αν δεν διδαχθούν οι ντόπιοι τα οφέλη του ρωμαϊκού πολιτισμού, οι φρουροί που παρακολουθούν από τον πύργο θα εμποδίσουν την επέκταση σε αυτήν την περιοχή." },
    { TR_BUILDING_INFO_CARAVANSERAI_MONTHLY_CONSUMPTION, "Μηνιαία κατανάλωση τροφίμων:" },
    { TR_CONFIG_CARAVANS_MOVE_OFF_ROAD, "Τα εμπορικά καραβάνια και τα κάρα με βόδια δεν δίνουν προτεραιότητα στα οδικά δίκτυα." },
    { TR_TOOLTIP_BUILDING_DISTRIBUTION_MAINTAINING, "Αποτρέπει όλους εκτός από τα αποθέματα καροτσιών να μετακινήσουν ή να πάρουν τον πόρο." },
    { TR_CONFIG_STORAGE_STEP_4, "Χρησιμοποιήστε πολλαπλάσια του 4 για την χωρητικότητα σιταποθηκών, αποθηκών και αποθηκών καροτσιών." },
    { TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT, "Αρχική σειρά στοιχείων της επάνω γραμμής" },
    { TR_TOOLTIP_DEPOT_MOVED, "Μετακίνηση πόρων:" },
    { TR_TOOLTIP_DEPOT_ORDER_TO, "σε" },
    { TR_TOOLTIP_RIGHT_CLICK_TO_DECREASE, "Κάντε δεξί κλικ για μείωση" },
    { TR_TOOLTIP_POPULATION_GOAL, "Στόχος πληθυσμού: " },
    { TR_CONFIG_PATRICIAN_DEVOLUTION_FIX, "Τα αριστοκρατικά σπίτια διατηρούν την ακεραιότητά τους κατά τη μεταβίβαση" },
    { TR_CONDITION_TEXT_TIME_LEFT_UNTIL_DEFEAT, "Χρόνος μέχρι την ήττα:" },
    { TR_CONDITION_TEXT_TIME_LEFT_UNTIL_VICTORY, "Χρόνος μέχρι τη νίκη:" },
    { TR_CHEAT_DISABLE_INVASIONS, "Απενεργοποίηση εισβολών" },
    { TR_CHEAT_DISABLE_LEGIONS_CONSUMPTION, "Απενεργοποίηση κατανάλωσης τροφής στρατιωτών" },
    { TR_ACTION_TYPE_CHANGE_TERRAIN, "Προσθήκη/αφαίρεση εδάφους" },
    { TR_PARAMETER_TERRAIN, "Έδαφος" },
    { TR_PARAMETER_ADD, "Προσθήκη" },
    { TR_PARAMETER_TERRAIN_TREE, "Δέντρο" },
    { TR_PARAMETER_TERRAIN_ROCK, "Βράχος" },
    { TR_PARAMETER_TERRAIN_WATER, "Νερό" },
    { TR_PARAMETER_TERRAIN_MEADOW, "Λιβάδι" },
    { TR_PARAMETER_TERRAIN_SHRUB, "Θάμνος" },
    { TR_TOOLTIP_BUTTON_ACCEPT_NATIVES, "Επιτρέψτε στους ντόπιους εμπόρους να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_NATIVES, "Μην επιτρέπετε στους ντόπιους εμπόρους να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_CAESAR, "Επιτρέψτε τα αιτήματα του Καίσαρα να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_CAESAR, "Μην επιτρέπετε τα αιτήματα του Καίσαρα να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_ACCEPT_ALL, "Επιτρέψτε σε όλους να έρθουν από εδώ" },
    { TR_TOOLTIP_BUTTON_REJECT_ALL, "Μην επιτρέπετε σε κανέναν να έρθει από εδώ." },
    { TR_TOOLTIP_OVERLAY_PROBLEMS_NO_ROAD_ACCESS, "Δεν υπάρχει οδική πρόσβαση" },
    { TR_WARNING_NO_WAREHOUSE_TOWER_ROAD_ACCESS, "Σύνδεση δρόμου με πύργο αποθήκης" },
    { TR_EDITOR_EARTHQUAKE_CUSTOM, "Προσαρμοσμένο" },
    { TR_EDITOR_TOOL_EARTHQUAKE_POINT, "Σημείο σεισμού" },
    { TR_EDITOR_TOOL_EARTHQUAKE_CUSTOM, "Προσαρμοσμένος σεισμός" },
    { TR_EDITOR_TOOL_EARTHQUAKE_REMOVE, "Αφαίρεση σεισμού" },
    { TR_ACTION_TYPE_CHANGE_MODEL_DATA, "Αλλαγή δεδομένων μοντέλου" },
    { TR_PARAMETER_MODEL, "Μοντέλο" },
    { TR_PARAMETER_DATA_TYPE, "Τύπος δεδομένων" },
    { TR_PARAMETER_COST, "Κόστος" },
    { TR_PARAMETER_DESIRABILITY_VALUE, "Αξία ελκυστικότητας" },
    { TR_PARAMETER_DESIRABILITY_STEP, "Βήμα ελκυστικότητας" },
    { TR_PARAMETER_DESIRABILITY_STEP_SIZE, "Μέγεθος βήματος ελκυστικότητας" },
    { TR_PARAMETER_DESIRABILITY_RANGE, "Εύρος ελκυστικότητας" },
    { TR_PARAMETER_LABORERS, "Εργάτες" },
    { TR_PARAMETER_SET, "Ρύθμιση" },
    { TR_PARAMETER_CHANGE, "Αλλαγή" },
    { TR_PARAMETER_OF, "από" },
    { TR_PARAMETER_TO, "σε" },
    { TR_PARAMETER_BY, "από" },
    { TR_BUILDING_FORT_MENU, "Φρούριο" },
    { TR_PARAMETER_VALUE_BUILDING_MENU_FORTS, "Όλα τα οχυρά" },
    { TR_EMPIRE_SIDE_BAR_SORT, "Ταξινόμηση κατά:" },
    { TR_EMPIRE_SIDE_BAR_FILTER, "Φιλτράρισμα κατά:" },
    { TR_EMPIRE_SIDE_BAR_SORT_BY_NAME, "Όνομα" },
    { TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_EXPORT, "Εξαγωγική ποσόστωση" },
    { TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_IMPORT, "Εισαγωγική ποσόστωση" },
    { TR_EMPIRE_SIDE_BAR_SORT_BY_ROUTE_COST, "Κόστος διαδρομής" },
    { TR_EMPIRE_SIDE_BAR_SORT_BY_PROFIT, "Κέρδος" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE, "Πόρος" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_SELL, "Πόρος (Πωλήθηκε)" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE_BUY, "Πόρος (αγοράστηκε)" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_OPEN, "Ανοιχτές διαδρομές" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_CLOSED, "Κλειστές διαδρομές" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_LAND, "Χερσαίες διαδρομές" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_SEA, "Θαλάσσιες διαδρομές" },
    { TR_EMPIRE_SIDE_BAR_FILTER_BY_NONE, "Χωρίς φίλτρο" },
    { TR_TOOLTIP_CHANGE_SIDEBAR_WIDTH, "Αλλαγή πλάτους πλευρικής στήλης" },
    { TR_TOOLTIP_ASCENDING_ORDER, "Αύξουσα σειρά" },
    { TR_TOOLTIP_DESCENDING_ORDER, "Φθίνουσα σειρά" },
    { TR_CHEAT_CHANGE_WEATHER, "Ο καιρός άλλαξε" },
    { TR_CONFIG_DEFAULT_GAME_SPEED, "Προεπιλεγμένη ταχύτητα παιχνιδιού:" },
    { TR_CONFIG_CATEGORY_GENERAL, "Γενικά" },
    { TR_CONFIG_CATEGORY_UI_MAP, "Κύλιση και χάρτης" },
    { TR_CONFIG_CATEGORY_UI_BUILDING, "Κτίριο" },
    { TR_CONFIG_CATEGORY_UI_CITY, "Θέα πόλεως" },
    { TR_CONFIG_CATEGORY_UI_WEATHER, "Καιρός" },
    { TR_CONFIG_CATEGORY_MANAGEMENT_STORAGE, "Αποθήκευση και αγορές" },
    { TR_CONFIG_CATEGORY_MANAGEMENT_ROADS, "Δρόμοι" },
    { TR_CONFIG_CATEGORY_MANAGEMENT_ROADBLOCKS, "Οδοφράγματα" },
    { TR_CONFIG_CATEGORY_MANAGEMENT_HOUSING, "Στέγαση" },
    { TR_EDITOR_CUSTOM_VARIABLES_TEXT_DISPLAY, "Κείμενο προς εμφάνιση" },
    { TR_EDITOR_CUSTOM_VARIABLES_IS_VISIBLE, "Ορατό" },
    { TR_ACTION_TYPE_CHANGE_CUSTOM_VARIABLE_VISIBILITY, "Αλλαγή ορατότητας προσαρμοσμένης μεταβλητής" },
    { TR_CONFIG_SHOW_CUSTOM_VARIABLES, "Εμφάνιση προσαρμοσμένων μεταβλητών στην προβολή πόλης" },
    ...
    { TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED, "Ενεργοποίηση «Λήψης» ενώ ένας πόρος είναι αποθηκευμένος" },
    { TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES, "Ασφαλτόστρωση δρόμων δίπλα σε σιταποθήκες" },
    { TR_CONFIG_UI_ANIMATE_TRADE_ROUTES, "Κίνηση γραφικών στις εμπορικές οδούς" },
    { TR_HOTKEY_NEXT_TRACK, "Επόμενο τυχαίο κομμάτι" },
    { TR_CONFIG_MOVE_LEGION_SOUND_SWAP, "Εναλλακτικός ήχος κίνησης λεγεώνας" },
    { TR_BUILDING_INFO_REPAIR_BUILDING, "Επισκευή κτιρίου" },
    { TR_WARNING_REPAIR_IMPOSSIBLE, "Δεν μπορεί να επισκευαστεί αυτό το κτίριο" },
    { TR_WARNING_REPAIR_BURNING, "Δεν είναι δυνατή η επισκευή ενώ το κτίριο βρίσκεται σε πυρκαγιά" },
    { TR_BUILDING_INFO_BUILDING_BURNING, "Το κτίριο έχει πάρει φωτιά" },
    { TR_BUILDING_LAND_REPAIR, "Επισκευή περιοχής" },
    { TR_BUILDING_LAND_CLEAR, "Καθαρισμός περιοχής" },
    { TR_CONFIRM_REPAIR_BUILDINGS, "Επισκευάστε όλα τα κτίρια στην περιοχή για " },
    { TR_CONFIRM_REPAIR_BUILDINGS_TITLE, "Επισκευή κτιρίων" },
    { TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS, "Ενεργοποίηση προηγμένων παραγγελιών αποθήκης καλαθιού" },
    { TR_BUILDING_INFO_INSTRUCTIONS, "οδηγίες" },
    { TR_BUILDING_INFO_ACTIVE_STORAGE_BUILDINGS, "Αποδοχή αποθηκευτικών κτιρίων" },
    { TR_BUILDING_INFO_OTHER_STORAGE_BUILDINGS, "Άλλα κτίρια αποθήκευσης" },
    { TR_TOOLTIP_GOTO_STORAGE_INSTRUCTIONS, "Ανοίξτε τις οδηγίες αποθήκευσης του κτιρίου" },
    { TR_BUILDING_INFO_CART_DEPOT_TOOLTIP_STYLE, "Στυλ εργαλείου υποδείξεων:" },
    { TR_TOOLTIP_NONE, "Κανένα" },
    { TR_TOOLTIP_MINIMAL, "Ελάχιστο" },
    { TR_TOOLTIP_FULL, "Πλήρης" },
    { TR_CONFIG_CLEAR_WARNINGS_RIGHTCLICK, "Κάντε δεξί κλικ για να διαγράψετε τις προειδοποιήσεις στην προβολή πόλης" },
    { TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN, "Τα αιτήματα του Καίσαρα αφορούν τη «διατήρηση»" },
    { TR_CONFIG_ENABLE_MARKET_RANGE, "Ενεργοποίηση εύρους αγοράς" },
    { TR_PARAMETER_TYPE_FORMULA, "Τύπος" },
    { TR_CONDITION_TYPE_CHECK_FORMULA, "Αξιολόγηση τύπων" },
    { TR_ACTION_TYPE_CUSTOM_VARIABLE_FORMULA, "Αλλαγή τιμής προσαρμοσμένης μεταβλητής (τύπος)" },
    { TR_EDITOR_REPEAT_INTERVAL_TYPE, "ΧΡΟΝΟΣ" },
    { TR_PLACEHOLDER, "Θέση κράτησης" },
    { TR_WARNING_CANT_REPAIR_MONUMENTS, "Τα μοναδικά μνημεία δεν μπορούν να επισκευαστούν" },
    { TR_WARNING_CANT_REPAIR_AQUEDUCTS, "Τα υδραγωγεία δεν μπορούν να επισκευαστούν" },
    { TR_OVERLAY_HOUSING_TENTS, "Σκηνές" },
    { TR_OVERLAY_HOUSING_SHACKS, "Παράγκες" },
    { TR_OVERLAY_HOUSING_HOVELS, "Καλύβες" },
    { TR_OVERLAY_HOUSING_CASAS, "Σπίτια" },
    { TR_OVERLAY_HOUSE_INSULAS, "Νησίδες" },
    { TR_OVERLAY_HOUSE_VILLAS, "Βίλες" },
    { TR_OVERLAY_HOUSE_PALACES, "Ανάκτορα" },
    { TR_OVERLAY_BY_GROUP, "Ανά ομάδα" },
    { TR_EDITOR_PARAMETER_CITY_PROPERTY, "Ακίνητα πόλεως" },
    { TR_EDITOR_ACTION_TYPE_CITY_PROPERTY, "Αλλαγή τιμής προσαρμοσμένης μεταβλητής (ιδιότητα πόλης)" },
    { TR_PARAMETER_PERCENTAGE, "Ποσοστό" },
    { TR_PARAMETER_ABSOLUTE, "Απόλυτο" },
    { TR_DECENNIUM_0, "0-9" },
    ...
    { TR_CITY_PROPERTY_NONE, "Κανένα" },
    { TR_CITY_PROPERTY_DIFFICULTY, "Δυσκολία" },
    { TR_CITY_PROPERTY_MONEY, "Χρήματα πόλης" },
    { TR_CITY_PROPERTY_POPULATION, "Πληθυσμός" },
    { TR_CITY_PROPERTY_SAVINGS, "Προσωπικές αποταμιεύσεις" },
    { TR_CITY_PROPERTY_YEAR_FINANCE_BALANCE, "Ετήσιο χρηματοοικονομικό ισοζύγιο" },
    { TR_CITY_PROPERTY_RESOURCE_STOCK, "Απόθεμα πόρων" },
    { TR_CITY_PROPERTY_STATS_FAVOR, "Ευνοία" },
    { TR_CITY_PROPERTY_STATS_PROSPERITY, "Ευημερία" },
    { TR_CITY_PROPERTY_STATS_CULTURE, "Πολιτισμός" },
    { TR_CITY_PROPERTY_STATS_PEACE, "Ειρήνη" },
    { TR_CITY_PROPERTY_STATS_CITY_HEALTH, "Υγεία πόλης" },
    { TR_CITY_PROPERTY_SERVICE_COVERAGE, "Κάλυψη υπηρεσίας" },
    { TR_CITY_PROPERTY_POPS_UNEMPLOYMENT, "Ανεργία" },
    { TR_CITY_PROPERTY_POPS_HOUSING_TYPE, "Πληθυσμός ανά τύπο κατοικίας" },
    { TR_CITY_PROPERTY_POPS_BY_AGE, "Πληθυσμός ανά ηλικία" },
    { TR_CITY_PROPERTY_ROME_WAGES, "Μισθοί στη Ρώμη" },
    { TR_CITY_PROPERTY_CITY_WAGES, "Μισθοί στην πόλη" },
    { TR_CITY_PROPERTY_BUILDING_COUNT, "Αριθμός κτιρίων" },
    { TR_CITY_PROPERTY_TROOPS_COUNT_PLAYER, "Στρατεύματα παίκτη" },
    { TR_CITY_PROPERTY_TROOPS_COUNT_ENEMY, "Εχθρικά στρατεύματα" },
    { TR_CITY_PROPERTY_TERRAIN_COUNT_TILES, "Πλακίδια εδάφους" },
    { TR_CITY_PROPERTY_TROOPS_MELEE, "Στρατιώτες μάχης" },
    { TR_CITY_PROPERTY_TROOPS_RANGED, "Στρατιώτες εξ αποστάσεως" },
    { TR_CITY_PROPERTY_TROOPS_MOUNTED, "Ιππικό" },
    { TR_CITY_PROPERTY_ALL, "Όλα" },
    { TR_CITY_PROPERTY_ACTIVE_ONLY, "Ενεργά μόνο" },
    { TR_CITY_PROPERTY_COVERAGE_THEATRE, "Κάλυψη θεάτρου" },
    { TR_CITY_PROPERTY_COVERAGE_ARENA, "Κάλυψη αρένας" },
    { TR_CITY_PROPERTY_COVERAGE_AMPHITHEATRE, "Κάλυψη αμφιθεάτρου" },
    { TR_CITY_PROPERTY_COVERAGE_TAVERN, "Κάλυψη ταβέρνας" },
    { TR_CITY_PROPERTY_COVERAGE_COLOSSEUM, "Κάλυψη Κολοσσαίου" },
    { TR_CITY_PROPERTY_COVERAGE_HIPPODROME, "Κάλυψη Ιπποδρόμου" },
    { TR_CITY_PROPERTY_COVERAGE_BATHS, "Κάλυψη λουτρών" },
    { TR_CITY_PROPERTY_COVERAGE_DOCTOR, "Κάλυψη γιατρού" },
    { TR_CITY_PROPERTY_COVERAGE_BARBER, "Κάλυψη κουρείου" },
    { TR_CITY_PROPERTY_COVERAGE_HOSPITAL, "Κάλυψη νοσοκομείου" },
    { TR_CITY_PROPERTY_COVERAGE_SCHOOL, "Κάλυψη σχολείου" },
    { TR_CITY_PROPERTY_COVERAGE_LIBRARY, "Κάλυψη βιβλιοθήκης" },
    { TR_CITY_PROPERTY_COVERAGE_ACADEMY, "Κάλυψη Ακαδημίας" },
    { TR_CITY_PROPERTY_CHOOSE_PROPERTY, "Επιλέξτε ακίνητο στην πόλη" },
    { TR_BUTTON_INFO_RETURN_ALL_LEGIONS, "Ανάκληση όλων των λεγεώνων" },
    { TR_CITY_PROPERTY_QUOTA_FILL, "Κάλυψη ποσοστώσεων" },
    { TR_EDITOR_BUYS, "(Αγοράζει)" },
    { TR_EDITOR_SELLS, "(Πωλεί)" },
    { TR_EDITOR_ALL_BUYS, "Όλα (Αγορές)" },
    { TR_EDITOR_ALL_SELLS, "Όλα (Πωλήσεις)" },
    { TR_ACTION_TYPE_WIN, "Άμεση νίκη" },
    { TR_ACTION_TYPE_LOSE, "Άμεση ήττα" },
    { TR_ACTION_TYPE_GOD_SENTIMENT, "Αλλαγή της γνώμης των θεών" },
    { TR_ACTION_TYPE_POP_SENTIMENT, "Αλλαγή της κοινής γνώμης" },
    { TR_MESSAGE_PROMOTE_RANK_PREFIX, "Εξαιρετικά νέα, κυβερνήτη! Εντυπωσιασμένος από την απόδοσή σου, ο Καίσαρας σε προήγαγε στο βαθμό του " },
    { TR_MESSAGE_DEMOTE_RANK_PREFIX, "Σοβαρά νέα, κυβερνήτη! Δυσαρεστημένος από την απόδοσή σου, ο Καίσαρας σε υποβίβασε στο βαθμό του " },
    { TR_MESSAGE_PROMOTE_RANK_SUFFIX, ". Συνοδεύεται από αύξηση μισθού, μπράβο!" },
    { TR_MESSAGE_DEMOTE_RANK_SUFFIX, ". Ο μισθός σου έχει μειωθεί!" },
    { TR_PARAMETER_TYPE_RANK, "Κατηγορία κυβερνήτη" },
    { TR_RANK_PROMOTE, "Προβιβασμός (+1 βαθμός)" },
    { TR_RANK_DEMOTE, "Υποβιβασμός (-1 βαθμός)" },
    { TR_RANK_CITIZEN, "Πολίτης" },
    { TR_RANK_CLERK, "Υπάλληλος" },
    { TR_RANK_ENGINEER, "Μηχανικός" },
    { TR_RANK_ARCHITECT, "Αρχιτέκτονας" },
    { TR_RANK_QUAESTOR, "Ταμίας" },
    { TR_RANK_PROCURATOR, "Δικηγόρος" },
    { TR_RANK_AEDILE, "Ειρηνοδίκης" },
    { TR_RANK_PRAETOR, "Πραίτορας" },
    { TR_RANK_CONSUL, "Ύπατος" },
    { TR_RANK_PROCONSUL, "Ἀνθύπατος" },
    { TR_RANK_CAESAR, "Καίσαρας" },
    { TR_ACTION_TYPE_CHANGE_RANK, "Αλλαγή βαθμού κυβερνήτη" },
    { TR_CITY_MESSAGE_TITLE_GOVERNOR_RANK_CHANGE, "Βαθμός κυβερνήτη" },
    { TR_TOOLTIP_OVERLAY_LEVY_PER_TILE, " Δηνάρια που καταβάλλονται μηνιαίως σε φόρους ανά πλακίδιο" },
    { TR_CONFIG_UI_CV_BUILD_MENU_ICONS, "Εμφάνιση εικονιδίων πόρων στο μενού δημιουργίας" },
    { TR_EDITOR_RESET_FAVOR_MONTHLY, "Επαναφορά μηνιαίας εύνοιας" },
    { TR_CONFIG_UI_WT_ENABLE_SNOW_CENTRAL, "Ενεργοποίηση χιονιού σε κεντρικό κλίμα" },
    { TR_EDITOR_UNABLE_TO_LOAD_MODEL_DATA_TITLE, "Δεν είναι δυνατή η φόρτωση του μοντέλου δεδομένων xml" },
    { TR_EDITOR_MODEL_DATA_IMPORT_FULL, "Εισαγωγή μοντέλου δεδομένων " },
    { TR_EDITOR_MODEL_DATA_EXPORT_FULL, "Εξαγωγή μοντέλου δεδομένων" },
    { TR_EDITOR_COLOR_LABEL, "Χρώμα" },
    { TR_EDITOR_COLOR_NONE, "Κανένα" },
    { TR_EDITOR_COLOR_BLUE, "Μπλε" },
    { TR_EDITOR_COLOR_ORANGE, "Πορτοκαλί" },
    { TR_EDITOR_COLOR_GREEN, "Πράσινο" },
    { TR_EDITOR_COLOR_PURPLE, "Μωβ" },
    { TR_EDITOR_COLOR_OLIVE, "Ελιά" },
    { TR_EDITOR_COLOR_TURQUOISE, "Τυρκουάζ" },
    { TR_EDITOR_COLOR_CORAL, "Κόκκινο" },
    { TR_EDITOR_COLOR_GRAY, "Γκρι" },
    { TR_EDITOR_COLOR_BLACK, "Μαύρο" },
    { TR_EDITOR_COLOR_DARK_BLUE, "Σκούρο μπλε" },
    { TR_EDITOR_RUBBLE, "Ερείπια" },
    { TR_PARAMETER_GRID_OFFSET_CORNER1, "Γωνία 1" },
    { TR_PARAMETER_GRID_OFFSET_CORNER2, "Γωνία 2" },
    { TR_CONDITION_TYPE_TERRAIN_IN_AREA, "Έδαφος στην περιοχή" },
    { TR_CONFIG_UI_CV_CURSOR_SHADOW, "Ενεργοποίηση σκιάς δρομέα" },
    { TR_EDITOR_MODEL_PRODUCTION, "Ρυθμός" },
    { TR_ACTION_TYPE_PRODUCTION_RATE, "Αλλαγή ρυθμού παραγωγής" },
    { TR_EDITOR_EARTHQUAKE_RIGHT_TO_LEFT, "Από δεξιά προς τα αριστερά" },
    { TR_EDITOR_EARTHQUAKE_RANDOM, "Τυχαία" },
    { TR_EDITOR_EARTHQUAKE_RANDOM_RIGHT_TO_LEFT, "Τυχαία από δεξιά προς αριστερά" },
    { TR_EDITOR_DESIRABILITY_VALUE, "Αξία ελκυστικότητάς\nΗ αρχική αξία του κτιρίου" },
    { TR_EDITOR_DESIRABILITY_STEP, "Βήμα ελκυστικότητάς\nΤο βήμα σε πλακίδια μέχρι την επόμενη αύξηση/μείωση της τιμής" },
    { TR_EDITOR_DESIRABILITY_STEP_SIZE, "Μέγεθος βήματος ελκυστικότητάς\nΤο ποσό που αυξάνεται/μειώνεται" },
    { TR_EDITOR_DESIRABILITY_RANGE, "Εύρος ελκυστικότητάς\nΤο μέγιστο εύρος πέρα από αυτό δεν έχει καμία επίδραση" },
    { TR_EDITOR_EARTHQUAKE_PATTERN, "Μοτίβο" },
    { TR_CONFIG_GENERAL_UNLOCK_MOUSE, "Κλείδωμα ποντικιού σε λειτουργία πλήρους οθόνης" },
    { TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS, "Τα σπίτια πάντα συγχωνεύονται σε 2x2" },
    { TR_EDITOR_EARTHQUAKE_CUSTOM_SET, "Προσαρμοσμένος σεισμός" },
    { TR_BUILDING_HOUSE_SMALL_TENT, "Μικρή σκηνή" },
    { TR_BUILDING_HOUSE_LARGE_TENT, "Μεγάλη σκηνή" },
    { TR_BUILDING_HOUSE_SMALL_SHACK, "Μικρή παράγκα" },
    { TR_BUILDING_HOUSE_LARGE_SHACK, "Μεγάλη παράγκα" },
    { TR_BUILDING_HOUSE_SMALL_HOVEL, "Μικρή καλύβα" },
    { TR_BUILDING_HOUSE_LARGE_HOVEL, "Μεγάλη καλύβα" },
    { TR_BUILDING_HOUSE_SMALL_CASA, "Μικρό σπίτι" },
    { TR_BUILDING_HOUSE_LARGE_CASA, "Μεγάλο σπίτι" },
    { TR_BUILDING_HOUSE_SMALL_INSULA, "Μικρή πολυκατοικία" },
    { TR_BUILDING_HOUSE_MEDIUM_INSULA, "Μεσαία πολυκατοικία" },
    { TR_BUILDING_HOUSE_LARGE_INSULA, "Μεγάλη πολυκατοικία" },
    { TR_BUILDING_HOUSE_GRAND_INSULA, "Τεράστια πολυκατοικία" },
    { TR_BUILDING_HOUSE_SMALL_VILLA, "Μικρή βίλα" },
    { TR_BUILDING_HOUSE_MEDIUM_VILLA, "Μεσαία βίλα" },
    { TR_BUILDING_HOUSE_LARGE_VILLA, "Μεγάλη βίλα" },
    { TR_BUILDING_HOUSE_GRAND_VILLA, "Μεγάλη βίλα" },
    { TR_BUILDING_HOUSE_SMALL_PALACE, "Μικρό Ανάκτορο" },
    { TR_BUILDING_HOUSE_MEDIUM_PALACE, "Μεσαίο Ανάκτορο" },
    { TR_BUILDING_HOUSE_LARGE_PALACE, "Μεγάλο Ανάκτορο" },
    { TR_BUILDING_HOUSE_LUXURY_PALACE, "Πολυτελές Ανάκτορο" },
    { TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES, "Εμφάνιση εύρους δεξαμενής κατά την κατασκευή κρηνών" },
    { TR_CHEAT_DESTROYED_BUILDING, "Κατεστραμμένο κτίριο" },
